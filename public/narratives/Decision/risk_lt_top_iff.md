# Proof narrative — risk_lt_top_iff

Root: **risk_lt_top_iff** (lemma) `Statlib/Decision/risk_lt_top_iff.lean:18` · topic `Decision`
...
· `risk_lt_top_iff` — lemma · `Statlib/Decision/risk_lt_top_iff.lean:18` **← headline**
