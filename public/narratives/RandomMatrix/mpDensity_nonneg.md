# Proof narrative — mpDensity_nonneg

Root: **mpDensity_nonneg** (lemma) `Statlib/RandomMatrix/mpDensity_nonneg.lean:20` · topic `RandomMatrix`
...
· `mpDensity_nonneg` — lemma · `Statlib/RandomMatrix/mpDensity_nonneg.lean:20` **← headline**
