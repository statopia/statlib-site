...
Root: **np_** (lemma) `Statlib/HypothesisTesting/NeymanPearson/ToTestFunction.lean:32` · topic `HypothesisTesting`
...
· `np_` — lemma · `Statlib/HypothesisTesting/NeymanPearson/ToTestFunction.lean:32` **← headline**
