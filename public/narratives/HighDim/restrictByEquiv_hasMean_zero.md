...
Root: **restrictByEquiv_hasMean_zero** (lemma) `Statlib/HighDim/Geometry/RIPConstruction.lean:317` · topic `HighDim`
...
· `restrictByEquiv_hasMean_zero` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:317` **← headline**
