...
Reading order (foundations first, headline last):
  ...
  ◆ `sampleSecondMoment` — noncomputable def · `Statlib/HighDim/CovarianceMatrix/SampleCovariance.lean:190`  _(also used by 5: sample_cov_max_eig_upper, sampleSecondMoment_unbiased, restricted_sample_deviation_quadratic, …)_
  ...
  ★ `sampleCovariance_confidence` — theorem · `Statlib/HighDim/CovarianceMatrix/SampleCovariance.lean:1316`  _(also used by 2: sample_cov_max_eig_upper, pca_eigvec_perturbation)_
...
flowchart TD
  ...
  n20["· projection_mean_zero"]
  n21["· scalar_sq_centered_exp_integrable"]
  n22["· sub_gauss_tail_abs"]
  n23["· sq_le_two_mul_exp"]
  n24["★ subgaussian_meas_abs_ge_le_two_exp"]
  n25["★ subgaussian_exp_sq_le_at_one_third"]
  n26["★ subgaussian_integrable_exp_sq_at_one_third"]
  n27["★ subexp_mgf_le_of_sq_subgaussian_explicit"]
  n28["· scalar_sq_centered_subexponential_explicit"]
  n29["▣ HasSubexponentialMGF"]
  n30["★ bernstein_sum_meas_abs_ge_le_two_exp"]
  n31["★ sampleCovariance_concentration"]
  n32["★ sampleCovariance_confidence"]
  n33["★ sample_cov_min_eig_lower"]
  n4 --> n1
  n5 --> n3
  n10 --> n8
  n10 --> n9
