...
Root: **measurable_restrictByEquiv** (lemma) `Statlib/HighDim/Geometry/RIPConstruction.lean:311` · topic `HighDim`
...
· `measurable_restrictByEquiv` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:311` **← headline**
