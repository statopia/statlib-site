# Proof narrative — l1_shell_localized_centered_tail_from_process_metric_good_cover_certificate_absorbed

Root: **l1_shell_localized_centered_tail_from_process_metric_good_cover_certificate_absorbed** (theorem) `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:1740` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ★ `l1_shell_localized_centered_deviation_tail_from_good_cover_absorbed` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:6845`  _(also used by 1: subgaussian_l1_shell_localized_centered_quadratic_deviation_tail_from_entrywise_good_cover)_
★ `l1_shell_localized_centered_tail_from_process_metric_good_cover_certificate_absorbed` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:1740` **← headline**
...
flowchart TD
  ...
  n22["★ l1_shell_localized_centered_tail_from_process_metric_good_cover_certificate_absorbed"]
  n7 --> n6
  n8 --> n6
  n9 --> n0
  n9 --> n1
