...
Root: **rip_implies_re** (theorem) `Statlib/HighDim/Geometry/RIPConstruction.lean:1637` · topic `HighDim`
...
★ `rip_implies_re` — theorem · `Statlib/HighDim/Geometry/RIPConstruction.lean:1637` **← headline**
