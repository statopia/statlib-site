...
Root: **offdiag_hanson_wright_tail_high_norm_bernstein_of_const_decoupling** (theorem) `Statlib/HighDim/Concentration/HansonWright.lean:3334` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ★ `zeroDiag_centered_quadratic_form_tail_high_norm_bernstein_of_const_decoupling` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:3195`  _(also used by 1: zeroDiag_centered_quadratic_form_tail_high_of_const_decoupling_norm_bernstein_absorb)_
★ `offdiag_hanson_wright_tail_high_norm_bernstein_of_const_decoupling` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:3334` **← headline**
