# Proof narrative — l1_shell_small_covariance_trivial_lower

Root: **l1_shell_small_covariance_trivial_lower** (lemma) `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:461` · topic `HighDim`
...
· `l1_shell_small_covariance_trivial_lower` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:461` **← headline**
...
flowchart TD
  n0["◆ l1Norm"]
  n1["◆ l2NormSq"]
  n2["· l1_shell_small_covariance_trivial_lower"]
  n2 --> n0
  n2 --> n1
  class n2 headline;
