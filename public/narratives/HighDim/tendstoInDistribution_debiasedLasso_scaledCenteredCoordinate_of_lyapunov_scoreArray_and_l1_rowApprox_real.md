# Proof narrative — tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_lyapunov_scoreArray_and_l1_rowApprox_real

Root: **tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_lyapunov_scoreArray_and_l1_rowApprox_real** (theorem) `Statlib/HighDim/Regression/DebiasingLasso.lean:938` · topic `HighDim`
Closure: 56 declarations across 14 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ◆ `LyapunovCondition` — def · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/Lyapunov.lean:24`  _(also used by 6: tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lyapunov_scoreArray_l1_rowApprox_and_se_real, tendsto_measure_studentizedDebiasedLasso_coordinate_coverageEvent_of_lyapunov_scoreArray_l1_rowApprox_and_se_real, tendsto_measure_debiasedLasso_waldCIHalfWidth_contains_coordinate_of_lyapunov_scoreArray_l1_rowApprox_and_limitMeasureCalibration_real, …)_
  ...
  ◆ `LindebergSum` — def · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/LindebergFeller.lean:25`  _(also used by 8: tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lindeberg_feller_scoreArray_l1_rowApprox_and_se_real, tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lyapunov_scoreArray_l1_rowApprox_and_se_real, tendsto_measure_studentizedDebiasedLasso_coordinate_coverageEvent_of_lindeberg_feller_scoreArray_l1_rowApprox_and_se_real, …)_
  ★ `lyapunov_condition_implies_lindeberg_condition` — theorem · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/Lyapunov.lean:41`  _(also used by 1: tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lyapunov_scoreArray_l1_rowApprox_and_se_real)_
  ...
  ★ `lindeberg_feller_central_limit_theorem` — theorem · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/LindebergFeller.lean:675`  _(also used by 3: tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lindeberg_feller_scoreArray_l1_rowApprox_and_se_real, tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lyapunov_scoreArray_l1_rowApprox_and_se_real, multiplierBootstrap_conditional_clt)_
  ...
  ★ `tendstoInDistribution_congr_left` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/ConvergenceModes.lean:257`  _(also used by 2: tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lindeberg_feller_scoreArray_l1_rowApprox_and_se_real, tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_lyapunov_scoreArray_l1_rowApprox_and_se_real)_
    ...
    ★ `tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_scoreCoordinate_and_l1_rowApprox_real` — theorem · `Statlib/HighDim/Regression/DebiasingLasso.lean:423`  _(also used by 2: tendstoInDistribution_studentizedDebiasedLasso_coordinate_of_scoreCoordinate_l1_rowApprox_and_se_real, tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_scoreCoordinate_gaussian_clt_and_l1_rowApprox_real)_
  ★ `tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_lindeberg_feller_scoreArray_and_l1_rowApprox_real` — theorem · `Statlib/HighDim/Regression/DebiasingLasso.lean:653`
★ `tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_lyapunov_scoreArray_and_l1_rowApprox_real` — theorem · `Statlib/HighDim/Regression/DebiasingLasso.lean:938` **← headline**

## Dependency diagram

```mermaid
flowchart TD
  n0["◆ LyapunovCondition"]
  ...
  n6["◆ l1Norm"]
  n7["◆ LindebergSum"]
  n8["★ lyapunov_condition_implies_lindeberg_condition"]
  n9["· charFun_gaussianReal_standard"]
  n10["· charfun_indep_sum_eq_prod"]
  n11["· var_ratio_le_lindeberg"]
  n12["· lindeberg_implies_max_var_tendsto"]
  n13["· norm_prod_sub_prod_le_sum_mul_pow"]
  n14["· prod_one_sub_tendsto_exp_neg"]
  n15["· norm_ofReal_mul_I"]
  n16["· norm_cexp_sub_quadratic_le"]
  n17["· norm_cexp_sub_quadratic_le_sq"]
  n18["· charfun_error_le_j"]
  n19["· sum_charfun_errors_le"]
  n20["★ charfun_lindeberg_pointwise"]
  ...
  n28["★ levy_continuity"]
  n29["★ lindeberg_feller_central_limit_theorem"]
  n30["◆ WeakConvergence"]
  n31["★ tendstoInDistribution_iff_weakConvergence_law"]
  n32["★ tendstoInDistribution_of_weakConvergence_law"]
  n33["★ tendstoInDistribution_of_probabilityMeasure_tendsto_and_gaussianReal_charFun"]
  n34["★ tendstoInDistribution_congr_left"]
  ...
  n54["★ tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_lindeberg_feller_scoreArray_and_l1_rowApprox_real"]
  n55["★ tendstoInDistribution_debiasedLasso_scaledCenteredCoordinate_of_lyapunov_scoreArray_and_l1_rowApprox_real"]
  n5 --> n4
  n8 --> n0
  n11 --> n7
  n12 --> n7
