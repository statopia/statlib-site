...
Root: **hanson_wright_isotropic** (theorem) `Statlib/HighDim/Concentration/HansonWright.lean:5490` · topic `HighDim`
Closure: 106 declarations across 11 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ▣ `HasMean` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:83`  _(also used by 37: coord_mul_subexponential_exists_of_indep, coord_mul_scaled_subexponential_exists_of_indep, coord_sq_centered_mgf_bound, …)_
  ...
  ◆ `decoupledOffDiagQuadForm` — noncomputable def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:33`  _(also used by 26: decoupledOffDiagQuadForm_const_right_abs_tail_real, decoupledOffDiagQuadForm_prod_mk_eq_const_right, decoupledOffDiagQuadForm_prod_first_section_abs_tail_real, …)_
      ...
      ★ `hanson_wright_tail_of_const_decoupling_norm_bernstein_absorb_of_exponents` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:4588`  _(also used by 1: hanson_wright_of_const_decoupling_norm_bernstein_absorb_of_exponents)_
    ★ `hanson_wright_tail_of_const_decoupling_scale_conditions` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:4681`
  ★ `hanson_wright` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:5455`
  · `quadratic_form_mean_isotropic` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:2944`
★ `hanson_wright_isotropic` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:5490` **← headline**
