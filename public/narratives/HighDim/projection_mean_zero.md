...
Root: **projection_mean_zero** (lemma) `Statlib/HighDim/CovarianceMatrix/SampleCovariance.lean:230` · topic `HighDim`
...
· `projection_mean_zero` — lemma · `Statlib/HighDim/CovarianceMatrix/SampleCovariance.lean:230` **← headline**
