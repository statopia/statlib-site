# Proof narrative — l1_shell_localized_centered_tail_from_shifted_process_metric_components_absorbed

Root: **l1_shell_localized_centered_tail_from_shifted_process_metric_components_absorbed** (theorem) `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:1914` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ★ `l1_shell_localized_centered_deviation_tail_from_shifted_good_cover_absorbed` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:6940`  _(also used by 1: l1_shell_localized_centered_tail_from_shifted_process_metric_good_cover_certificate_absorbed)_
★ `l1_shell_localized_centered_tail_from_shifted_process_metric_components_absorbed` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:1914` **← headline**
...
flowchart TD
  ...
  n22["★ l1_shell_localized_centered_tail_from_shifted_process_metric_components_absorbed"]
  n7 --> n6
  n8 --> n6
  n9 --> n0
  n9 --> n1
