...
Reading order (foundations first, headline last):
    ...
    ★ `real_log_matrix_isHermitian_of_posDef` — theorem · `Statlib/HighDim/MatrixAnalysis/TraceExp.lean:71`  _(also used by 4: matrix_lieb_one_step_trace, quantumRelativeEntropy_eq_perspectiveInner, perspectiveInner_jointConvex, …)_
    ★ `real_matrix_exp_log_of_posDef` — theorem · `Statlib/HighDim/MatrixAnalysis/TraceExp.lean:76`  _(also used by 2: matrix_lieb_one_step_trace, quantumRelativeEntropy_eq_perspectiveInner)_
