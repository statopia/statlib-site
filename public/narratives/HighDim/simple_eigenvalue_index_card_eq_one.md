...
Root: **simple_eigenvalue_index_card_eq_one** (lemma) `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:692` · topic `HighDim`
...
· `simple_eigenvalue_index_card_eq_one` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:692` **← headline**
