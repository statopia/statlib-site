...
Root: **offDiagCoeff_norm_sq_le** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:744` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ◆ `offDiagCoeff` — noncomputable def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:39`  _(also used by 3: offDiagCoeff_const, decoupledOffDiagQuadForm_eq_sum_coeff, decoupledOffDiagQuadForm_eq_inner_coeff)_
    ◆ `zeroDiagMatrix` — def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:52`  _(also used by 39: offDiagCoeffVec_eq_zeroDiagMatrix_mulVec, offDiagCoeffVec_norm_le_zeroDiag, diagQuadForm_zeroDiagMatrix, …)_
      · `offDiagCoeff_eq_zeroDiagMatrix_mulVec` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:217`
    · `offDiagCoeff_norm_le_zeroDiag` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:243`
    ...
    · `zeroDiagMatrix_norm_le_two` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:704`  _(also used by 2: offDiagCoeffVec_norm_le, zeroDiag_hanson_scale_half_le)_
  · `offDiagCoeff_norm_le` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:721`
· `offDiagCoeff_norm_sq_le` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:744` **← headline**
