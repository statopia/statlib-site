...
Reading order (foundations first, headline last):
  ...
  ▣ `HasCovarianceMatrix` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:101`  _(also used by 14: secondMoment_eq_cov_centered, subgaussian_variance_bound, subgaussian_cov_offdiag_bound, …)_
