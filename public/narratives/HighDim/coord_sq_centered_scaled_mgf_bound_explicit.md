...
Root: **coord_sq_centered_scaled_mgf_bound_explicit** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:1970` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ▣ `IsSubGaussianVector` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:52`  _(also used by 77: decoupledOffDiagQuadForm_const_right_subgaussian, decoupledOffDiagQuadForm_const_right_abs_tail_real, decoupledOffDiagQuadForm_prod_first_section_abs_tail_real, …)_
    ...
    · `subgaussian_vector_coord` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1340`  _(also used by 18: coord_mul_subexponential_exists_of_indep, coord_sq_centered_mgf_bound, coord_sq_centered_scaled_exp_integrable, …)_
  ...
  · `coord_sq_centered_mgf_bound_explicit` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1951`  _(also used by 2: coord_sq_centered_scaled_subexponential_explicit_of_range, cov_trace_concentration)_
· `coord_sq_centered_scaled_mgf_bound_explicit` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1970` **← headline**
