# Proof narrative — subgaussian_variance_bound

Root: **subgaussian_variance_bound** (lemma) `Statlib/HighDim/Properties.lean:70` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ▣ `IsSubGaussianVector` — structure · `Statlib/Vocabulary/RandomVector.lean:52`  _(also used by 11: hanson_wright, hanson_wright_isotropic, subgaussian_cov_offdiag_bound, …)_
...
· `subgaussian_variance_bound` — lemma · `Statlib/HighDim/Properties.lean:70` **← headline**
