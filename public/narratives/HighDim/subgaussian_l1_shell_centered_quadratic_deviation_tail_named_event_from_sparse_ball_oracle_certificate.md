# Proof narrative — subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_sparse_ball_oracle_certificate

Root: **subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_sparse_ball_oracle_certificate** (theorem) `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:4747` · topic `HighDim`
Closure: 81 declarations across 13 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ▣ `HasMean` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:83`  _(also used by 110: frobenius_norm_sq_subgaussian_concentration, gaussian_quadratic_form_concentration, coord_mul_integral_eq_zero_of_indep, …)_
  ▣ `HasCovarianceMatrix` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:101`  _(also used by 92: cov_diagonal_concentration, cov_quadratic_deviation, cov_quadratic_deviation_unit_shifted_lower_tail, …)_
  ▣ `IsSubGaussianVector` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:52`  _(also used by 154: frobenius_norm_sq_subgaussian_concentration, gaussian_quadratic_form_concentration, decoupledOffDiagQuadForm_const_right_subgaussian, …)_
  ◆ `l1Norm` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:17`  _(also used by 170: l1_linear_rademacher_complexity_bound, finite_l1_quadratic_rademacher_coord_bound, finite_l1_quadratic_rademacher_coord_energy_bound, …)_
  ◆ `l2NormSq` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:13`  _(also used by 191: matrixRowVec_norm_sq, offDiagCoeffVec_norm_sq_le_frobenius, offDiagCoeffVec_norm_sq_integral_le_frobenius, …)_
  ◆ `IsSparse` — def · `Statlib/HighDim/Vocabulary/Sparse.lean:36`  _(also used by 43: threshold_head_quadratic_remainder_abs_from_bilinear_l2_tail, subgaussian_l1_shell_localized_centered_tail_from_sparse_approximation_cover, subgaussian_l1_shell_localized_centered_tail_from_sparse_ball_approximation_cover, …)_
  ◆ `l1_shell_centered_quadratic_deviation_bad_event` — def · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:536`  _(also used by 8: subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_coordinate_rate, subgaussian_l1_shell_centered_quadratic_deviation_tail_from_one_scale_centered_entry_schedule_named_event, subgaussian_l1_shell_centered_quadratic_deviation_tail_from_final_tau_unit_sampledev_schedule_named_event, …)_
      ...
      · `l1_shell_centered_deviation_tail_from_normalized_large_l2_tail` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:3353`  _(also used by 2: subgaussian_l1_shell_centered_quadratic_deviation_tail_from_sparse_ball_oracle_final_rate, subgaussian_l1_shell_centered_quadratic_deviation_tail_from_sparse_oracle_final_rate)_
    ★ `subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_entrywise_l1_cover` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:4374`
  ...
  ★ `subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_entrywise_l1_cover_certificate` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:4471`
  ...
  · `exists_localized_l1_cover_from_sparse_ball` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1596`  _(also used by 1: subgaussian_l1_shell_localized_centered_tail_from_sparse_ball_approximation_cover)_
★ `subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_sparse_ball_oracle_certificate` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:4747` **← headline**
