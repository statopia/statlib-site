...
Root: **zeroDiag_centered_quadratic_form_tail_high_of_decoupling_and_decoupled_tail** (theorem) `Statlib/HighDim/Concentration/HansonWright.lean:2926` · topic `HighDim`
...
★ `zeroDiag_centered_quadratic_form_tail_high_of_decoupling_and_decoupled_tail` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:2926` **← headline**
