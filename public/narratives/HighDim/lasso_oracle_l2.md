...
Root: **lasso_oracle_l2** (theorem) `Statlib/HighDim/Regression/LassoOracle.lean:719` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ◆ `IsLassoSolution` — def · `Statlib/HighDim/Regression/LassoOracle.lean:50`  _(also used by 1: lasso_oracle_l1)_
    · `lasso_basic_inequality` — lemma · `Statlib/HighDim/Regression/LassoOracle.lean:62`  _(also used by 1: lasso_oracle_l1)_
  · `lasso_cone_condition` — lemma · `Statlib/HighDim/Regression/LassoOracle.lean:220`  _(also used by 1: lasso_oracle_l1)_
  ★ `lasso_oracle_prediction` — theorem · `Statlib/HighDim/Regression/LassoOracle.lean:354`
★ `lasso_oracle_l2` — theorem · `Statlib/HighDim/Regression/LassoOracle.lean:719` **← headline**
