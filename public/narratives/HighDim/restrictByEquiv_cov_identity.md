...
Root: **restrictByEquiv_cov_identity** (lemma) `Statlib/HighDim/Geometry/RIPConstruction.lean:327` · topic `HighDim`
...
· `restrictByEquiv_cov_identity` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:327` **← headline**
