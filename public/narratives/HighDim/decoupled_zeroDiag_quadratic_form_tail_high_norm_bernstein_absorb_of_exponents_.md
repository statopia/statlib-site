...
Root: **decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb_of_exponents'** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:2797` · topic `HighDim`
Closure: 60 declarations across 11 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ▣ `HasMean` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:83`  _(also used by 47: coord_mul_integral_eq_zero_of_indep, offDiagQuadForm_integral_eq_zero_of_indep, offDiagQuadForm_centered_eq_self_of_indep, …)_
  ▣ `IsSubGaussianVector` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:52`  _(also used by 56: decoupledOffDiagQuadForm_const_right_abs_tail_real, decoupledOffDiagQuadForm_prod_first_section_abs_tail_real, subgaussian_projection_sq_integrable, …)_
  ...
  · `decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb_of_exponents` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:2725`  _(also used by 1: zeroDiag_centered_quadratic_form_tail_high_of_const_decoupling_norm_bernstein_absorb_of_exponents)_
· `decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb_of_exponents'` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:2797` **← headline**
...
flowchart TD
  ...
  n6["· inner_eq_sum"]
  n7["· subgaussian_vector_coord"]
  n8["★ subgaussian_variance_le"]
  n9["· subgaussian_projection_second_moment_le"]
  n10["· subgaussian_norm_sq_mean_le_dim"]
  n11["▣ HasSubexponentialMGF"]
  n12["★ subgaussian_meas_abs_ge_le_two_exp"]
  n13["★ subgaussian_integrable_exp_sq_at_one_third"]
  n14["· coord_sq_centered_scaled_exp_integrable"]
  n15["· sub_gauss_tail_abs"]
  n16["· sq_le_two_mul_exp"]
  n17["★ subgaussian_exp_sq_le_at_one_third"]
  n18["★ subexp_mgf_le_of_sq_subgaussian_explicit"]
  n19["· coord_sq_centered_mgf_bound_explicit"]
  n20["· coord_sq_centered_scaled_subexponential_explicit_of_range"]
  n21["★ bernstein_sum_meas_abs_ge_le_two_exp"]
  n22["· weighted_coord_sq_centered_sum_tail_explicit"]
  n23["· subgaussian_norm_sq_tail_bernstein_explicit"]
  n24["◆ offDiagCoeffVec"]
  n25["· decoupledOffDiagQuadForm_measurable"]
  n26["· decoupledOffDiagQuadForm_prod_measurable"]
  n27["· decoupledOffDiagQuadForm_prod_tail_measurableSet"]
  n28["· offDiagCoeffVec_comp_measurable"]
  n29["· offDiagCoeffVec_norm_sq_measurable"]
  n30["· subgaussian_mgf_mono_param"]
  n31["◆ offDiagCoeff"]
  n32["· decoupledOffDiagQuadForm_eq_sum_coeff"]
  n33["· decoupledOffDiagQuadForm_eq_inner_coeff"]
  n34["· offDiagCoeff_const"]
  n35["· decoupledOffDiagQuadForm_const_right_eq_inner_coeffVec"]
  n36["· decoupledOffDiagQuadForm_const_right_subgaussian"]
  n37["· subgaussian_abs_tail_real"]
  n38["· decoupledOffDiagQuadForm_const_right_abs_tail_real_of_coeff_norm_sq_le"]
  n39["· measure_le_ofReal_of_measureReal_le"]
  n40["· decoupledOffDiagQuadForm_prod_tail_le_bad_plus_good"]
  n41["◆ zeroDiagMatrix"]
  ...
  n54["· decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb"]
  n55["· add_le_of_le_half_of_le_half"]
  n56["· decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb_split"]
  n57["· two_mul_exp_neg_le_half_exp_neg_hanson_high"]
  n58["· decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb_of_exponents"]
  n59["· decoupled_zeroDiag_quadratic_form_tail_high_norm_bernstein_absorb_of_exponents'"]
  n5 --> n4
  n7 --> n1
  n7 --> n6
  n9 --> n1
