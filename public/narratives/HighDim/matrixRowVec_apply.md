...
Root: **matrixRowVec_apply** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:459` · topic `HighDim`
...
· `matrixRowVec_apply` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:459` **← headline**
