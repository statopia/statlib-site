...
Root: **matrixRowVec_apply** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:411` · topic `HighDim`
...
· `matrixRowVec_apply` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:411` **← headline**
