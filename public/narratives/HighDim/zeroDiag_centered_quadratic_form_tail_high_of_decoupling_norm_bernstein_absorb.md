...
Root: **zeroDiag_centered_quadratic_form_tail_high_of_decoupling_norm_bernstein_absorb** (theorem) `Statlib/HighDim/Concentration/HansonWright.lean:3300` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ★ `zeroDiag_centered_quadratic_form_tail_high_norm_bernstein_of_decoupling` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:3067`  _(also used by 1: offdiag_hanson_wright_tail_high_norm_bernstein_of_decoupling)_
★ `zeroDiag_centered_quadratic_form_tail_high_of_decoupling_norm_bernstein_absorb` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:3300` **← headline**
