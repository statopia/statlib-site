...
Reading order (foundations first, headline last):
  ...
  ▣ `HasZeroMean` — structure · `Statlib/HighDim/Vocabulary/RandomMatrix.lean:62`  _(also used by 4: hermitianDilationFin_hasZeroMean, matrix_bernstein_rect, WignerSymmetric, …)_
  ...
  ★ `hermitian_l2_opNorm_lt_of_posDef_sub_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:590`  _(also used by 1: matrix_bernstein_rect)_
    ...
    ★ `matrix_integral_apply_of_integrable` — theorem · `Statlib/HighDim/MatrixAnalysis/TraceExp.lean:291`  _(also used by 1: hermitianDilationFin_integral_mul_self_of_integrable)_
