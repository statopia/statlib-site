...
Root: **lasso_noise_condition** (theorem) `Statlib/HighDim/Concentration/SubGaussianMax.lean:577` · topic `HighDim`
...
★ `lasso_noise_condition` — theorem · `Statlib/HighDim/Concentration/SubGaussianMax.lean:577` **← headline**
