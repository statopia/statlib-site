...
Root: **subgaussian_rip_sample_complexity** (theorem) `Statlib/HighDim/Geometry/RIPConstruction.lean:1617` · topic `HighDim`
Closure: 51 declarations across 17 files. Generated from `proof_graph.json` — no files were moved.
...
Reading order (foundations first, headline last):
  ...
  ▣ `IsSubGaussianVector` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:52`  _(also used by 75: decoupledOffDiagQuadForm_const_right_subgaussian, decoupledOffDiagQuadForm_const_right_abs_tail_real, decoupledOffDiagQuadForm_prod_first_section_abs_tail_real, …)_
    ...
    ◆ `l2NormSq` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:13`  _(also used by 26: matrixRowVec_norm_sq, offDiagCoeffVec_norm_sq_le_frobenius, offDiagCoeffVec_norm_sq_integral_le_frobenius, …)_
...
★ `subgaussian_rip_sample_complexity` — theorem · `Statlib/HighDim/Geometry/RIPConstruction.lean:1617` **← headline**
...
flowchart TD
  ...
  n11["· scalar_sq_centered_exp_integrable"]
  n12["· sub_gauss_tail_abs"]
  n13["· sq_le_two_mul_exp"]
  n14["★ subgaussian_meas_abs_ge_le_two_exp"]
  n15["★ subgaussian_exp_sq_le_at_one_third"]
  n16["★ subgaussian_integrable_exp_sq_at_one_third"]
