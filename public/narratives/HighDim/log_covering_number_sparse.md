...
Root: **log_covering_number_sparse** (theorem) `Statlib/HighDim/Geometry/CoveringNumbers.lean:816` · topic `HighDim`
Closure: 5 declarations across 3 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ◆ `IsSparse` — def · `Statlib/HighDim/Vocabulary/Sparse.lean:36`  _(also used by 14: covering_number_sparse_ball, isSparse_mono, isSparse_neg, …)_
...
★ `log_covering_number_sparse` — theorem · `Statlib/HighDim/Geometry/CoveringNumbers.lean:816` **← headline**
