...
Root: **rip_upper_restrictTo** (lemma) `Statlib/HighDim/Geometry/RIPConstruction.lean:305` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ◆ `SatisfiesRIP` — def · `Statlib/HighDim/Vocabulary/DesignMatrix.lean:241`  _(also used by 5: rip_cross_term_abs_le_half_delta_sum, rip_lower_restrictTo, subgaussian_rip_tail, …)_
  ...
  · `restrictTo_sparse` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:135`  _(also used by 1: rip_lower_restrictTo)_
  · `restrictTo_l2NormSq` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:141`  _(also used by 1: rip_lower_restrictTo)_
· `rip_upper_restrictTo` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:305` **← headline**
