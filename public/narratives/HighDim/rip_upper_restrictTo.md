...
Reading order (foundations first, headline last):
  ...
  ◆ `SatisfiesRIP` — def · `Statlib/HighDim/Vocabulary/DesignMatrix.lean:260`  _(also used by 5: rip_cross_term_abs_le_half_delta_sum, rip_lower_restrictTo, subgaussian_rip_tail, …)_
