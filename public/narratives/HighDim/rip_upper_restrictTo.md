...
Root: **rip_upper_restrictTo** (lemma) `Statlib/HighDim/Geometry/RIPConstruction.lean:302` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  · `restrictTo_sparse` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:132`  _(also used by 1: rip_lower_restrictTo)_
  · `restrictTo_l2NormSq` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:138`  _(also used by 1: rip_lower_restrictTo)_
· `rip_upper_restrictTo` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:302` **← headline**
