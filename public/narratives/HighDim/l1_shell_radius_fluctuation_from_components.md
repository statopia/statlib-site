# Proof narrative — l1_shell_radius_fluctuation_from_components

Root: **l1_shell_radius_fluctuation_from_components** (lemma) `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:231` · topic `HighDim`
...
· `l1_shell_radius_fluctuation_from_components` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess/RadiusFluctuation.lean:231` **← headline**
...
flowchart TD
  n0["◆ l2NormSq"]
  n1["◆ l1Norm"]
  n2["· l1_shell_radius_fluctuation_from_components"]
  n2 --> n0
  n2 --> n1
  class n2 headline;
