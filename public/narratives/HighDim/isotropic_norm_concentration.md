...
Root: **isotropic_norm_concentration** (lemma) `Statlib/HighDim/CovarianceMatrix/Properties.lean:761` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ◆ `IsIsotropic` — def · `Statlib/HighDim/Vocabulary/RandomVector.lean:109`  _(also used by 6: gaussian_quadratic_form_concentration, quadratic_form_mean_isotropic, hanson_wright_isotropic, …)_
  ▣ `IsSubGaussianVector` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:52`  _(also used by 170: frobenius_norm_sq_subgaussian_concentration, gaussian_quadratic_form_concentration, decoupledOffDiagQuadForm_const_right_subgaussian, …)_
    ▣ `HasSubexponentialMGF` — structure · `Statlib/StatFoundation/Vocabulary/RandomVariable.lean:74`  _(also used by 30: coord_mul_subexponential_exists_of_indep, subexponential_mgf_const_mul_relaxed, coord_mul_scaled_subexponential_exists_of_indep, …)_
        ...
        · `subgaussian_vector_coord` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1341`  _(also used by 18: coord_mul_subexponential_exists_of_indep, coord_sq_centered_mgf_bound, weighted_coord_sq_centered_sum_tail_explicit, …)_
    ...
    · `coord_sq_centered_scaled_subexponential_explicit_of_range` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:2097`  _(also used by 2: weighted_coord_sq_centered_sum_tail_explicit, diag_hanson_wright_tail_high)_
  ...
  · `subgaussian_norm_sq_subexponential` — lemma · `Statlib/HighDim/CovarianceMatrix/Properties.lean:565`
  · `isotropic_mean_sq_norm` — lemma · `Statlib/HighDim/CovarianceMatrix/Properties.lean:732`
...
· `isotropic_norm_concentration` — lemma · `Statlib/HighDim/CovarianceMatrix/Properties.lean:761` **← headline**
