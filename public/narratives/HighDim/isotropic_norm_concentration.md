...
Root: **isotropic_norm_concentration** (lemma) `Statlib/HighDim/Properties.lean:118` · topic `HighDim`
...
· `isotropic_norm_concentration` — lemma · `Statlib/HighDim/Properties.lean:118` **← headline**
...
flowchart TD
  ...
  n4["· isotropic_norm_concentration"]
  n2 --> n1
  n4 --> n0
  n4 --> n2
  n4 --> n3
