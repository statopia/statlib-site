...
Root: **matrix_bernstein_rect** (theorem) `Statlib/HighDim/Concentration/MatrixBernstein.lean:4216` · topic `HighDim`
Closure: 176 declarations across 17 files. Generated from `proof_graph.json` — no files were moved.
...
Reading order (foundations first, headline last):
  ...
  ★ `measurable_hermitianDilationFin` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2735`
    ★ `hermitianDilation_isHermitian` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2214`
  ★ `hermitianDilationFin_isHermitian` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2456`
  ★ `measurable_hermitianDilationFin_map` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2756`
  ★ `hermitianDilationFin_hasZeroMean` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2764`
  ★ `matrix_reindex_l2_opNorm_le` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2165`
    ★ `hermitianDilation_l2_opNorm_le` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2243`
  ★ `hermitianDilationFin_l2_opNorm_le` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2417`
  ...
  ★ `integrable_mul_transpose_of_bounded_meas` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2652`
    ★ `integrable_transpose_mul_of_bounded` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2634`
  ...
  ★ `hermitianDilationFin_sum_integral_mul_self_of_integrable` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2670`
  ★ `fromBlocks_diagonal_l2_opNorm_le_max` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2342`
      ★ `hermitianDilation_zero` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2221`  _(also used by 1: hermitianDilation_sum)_
    ★ `hermitianDilationFin_zero` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2434`
      ★ `hermitianDilation_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2225`  _(also used by 1: hermitianDilation_sum)_
    ★ `hermitianDilationFin_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2438`
  ★ `hermitianDilationFin_sum` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2444`
  ★ `hermitianDilationFin_posDef_add_of_sub` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2487`
  ...
  ★ `hermitian_l2_opNorm_lt_of_posDef_sub_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:590`  _(also used by 1: matrix_bernstein)_
      ★ `matrix_reindex_l2_opNorm_eq` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2199`
    ★ `hermitianDilationFin_l2_opNorm_eq_hermitianDilation` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2423`
      ★ `l2_opNorm_le_hermitianDilation` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2308`
    ★ `hermitianDilation_l2_opNorm_eq` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2337`
  ★ `hermitianDilationFin_l2_opNorm_eq` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2428`
  ...
  ★ `matrix_bernstein_one_sided` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2855`  _(also used by 1: matrix_bernstein)_
★ `matrix_bernstein_rect` — theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:4216` **← headline**

> Closure has 176 declarations — diagram omitted (cap 60).
