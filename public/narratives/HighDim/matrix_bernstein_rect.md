...
Root: **matrix_bernstein_rect** (theorem) `Statlib/HighDim/Concentration/MatrixBernstein.lean:4582` · topic `HighDim`
Closure: 133 declarations across 5 files. Generated from `proof_graph.json` — no files were moved.
...
Reading order (foundations first, headline last):
  ...
  ◆ `HasBoundedSpectralNorm` — def · `Statlib/HighDim/Vocabulary/RandomMatrix.lean:38`  _(also used by 1: matrix_bernstein)_
    ◆ `hermitianDilation` — private def · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2544`  _(also used by 1: hermitianDilation_sum)_
  ◆ `hermitianDilationFin` — private def · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2749`
  ★ `measurable_hermitianDilationFin` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:3071`
    ★ `hermitianDilation_isHermitian` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2550`
  ★ `hermitianDilationFin_isHermitian` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2792`
  ★ `measurable_hermitianDilationFin_map` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:3092`
  ★ `hermitianDilationFin_hasZeroMean` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:3100`
  ★ `matrix_reindex_l2_opNorm_le` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2501`
    ★ `hermitianDilation_l2_opNorm_le` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2579`
  ★ `hermitianDilationFin_l2_opNorm_le` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2753`
  ...
  ★ `integrable_mul_transpose_of_bounded_meas` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2988`
    ★ `integrable_transpose_mul_of_bounded` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2970`
    ★ `measurable_transpose_mul` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2942`
  ★ `integrable_transpose_mul_of_bounded_meas` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2997`
  ★ `hermitianDilationFin_transpose` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2801`
    ...
    ★ `matrix_integral_apply_of_integrable` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:1269`
        ★ `hermitianDilation_mul_self` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2742`
      ★ `hermitianDilationFin_mul_self` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2886`
    ★ `hermitianDilationFin_integral_mul_self_of_integrable` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2898`
  ★ `hermitianDilationFin_sum_integral_mul_self_of_integrable` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:3006`
  ★ `fromBlocks_diagonal_l2_opNorm_le_max` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2678`
      ★ `hermitianDilation_zero` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2557`  _(also used by 1: hermitianDilation_sum)_
    ★ `hermitianDilationFin_zero` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2770`
      ★ `hermitianDilation_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2561`  _(also used by 1: hermitianDilation_sum)_
    ★ `hermitianDilationFin_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2774`
  ★ `hermitianDilationFin_sum` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2780`
  ★ `hermitianDilationFin_posDef_add_of_sub` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2823`
  ...
  ★ `hermitian_l2_opNorm_lt_of_posDef_sub_add` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:1040`  _(also used by 1: matrix_bernstein)_
      ★ `matrix_reindex_l2_opNorm_eq` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2535`
    ★ `hermitianDilationFin_l2_opNorm_eq_hermitianDilation` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2759`
      ★ `l2_opNorm_le_hermitianDilation` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2644`
    ★ `hermitianDilation_l2_opNorm_eq` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2673`
  ★ `hermitianDilationFin_l2_opNorm_eq` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:2764`
      ...
      ★ `iIndepFun_matrix_sum_indep_of_notMem` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:1583`
        ...
        ★ `real_log_matrix_le_of_exp_sub_posSemidef` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:629`
          ◆ `sortedEigenvalues` — noncomputable def · `Statlib/HighDim/Vocabulary/Spectral.lean:11`  _(also used by 10: davis_kahan_subspace, sortedEigenvalues_zero_le_eigenvalue, eigenvalue_le_sortedEigenvalues_last, …)_
            ...
            · `finrank_eigenSubspaceLe` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:442`  _(also used by 1: weyl_sorted_upper)_
            ...
            · `sortedEigenvalues_lt_card_eigen_le_sorted` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:76`  _(also used by 1: weyl_sorted_upper)_
            · `finrank_eigenSubspaceGt` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:486`  _(also used by 1: weyl_sorted_upper)_
            ...
            · `card_eigen_gt_ge_of_sorted_gt` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:145`  _(also used by 1: weyl_sorted_upper)_
            · `exists_ne_zero_mem_inf_of_finrank_lt_add` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:837`  _(also used by 1: weyl_sorted_upper)_
            · `toEuclideanLin_eigenvectorBasis` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:198`
            · `toEuclideanLin_sum_repr` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:205`  _(also used by 1: toEuclideanLin_sub_smul_eq_sum_eigen_sub)_
            · `hermitian_rayleigh_eq_sum_eigen` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:223`
            · `orthonormalBasis_norm_sq_eq_sum_repr_sq` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:256`  _(also used by 1: off_target_energy_eq_one_sub_single_coeff_sq)_
            ...
            · `eigenSubspaceLe_rayleigh_le` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:477`  _(also used by 1: weyl_sorted_upper)_
            ...
            · `eigenSubspaceGt_rayleigh_gt` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:570`  _(also used by 1: weyl_sorted_upper)_
          ★ `sortedEigenvalues_le_of_add_posSemidef` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:640`
          · `sortedEigenvalues_perm` — lemma · `Statlib/HighDim/SpectralPerturbation/Eigenvalues.lean:44`
  ...
  ★ `matrix_bernstein_one_sided` — private theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:3190`  _(also used by 1: matrix_bernstein)_
★ `matrix_bernstein_rect` — theorem · `Statlib/HighDim/Concentration/MatrixBernstein.lean:4582` **← headline**

> Closure has 133 declarations — diagram omitted (cap 60).
