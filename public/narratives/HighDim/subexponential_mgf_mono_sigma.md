...
Root: **subexponential_mgf_mono_sigma** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:1989` · topic `HighDim`
...
· `subexponential_mgf_mono_sigma` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1989` **← headline**
...
flowchart TD
  ...
  n1["· subexponential_mgf_mono_sigma"]
  n1 --> n0
  class n1 headline;
