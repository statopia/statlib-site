# Proof narrative — subgaussian_design_l1RSE_from_sparse_ball_oracle_final_rate

Root: **subgaussian_design_l1RSE_from_sparse_ball_oracle_final_rate** (theorem) `Statlib/HighDim/Regression/L1RSEFromCovariance.lean:294` · topic `HighDim`
Closure: 91 declarations across 14 files. Generated from `proof_graph.json` — no files were moved.
...
Reading order (foundations first, headline last):
  ...
  ◆ `l1Norm` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:17`  _(also used by 163: l1_linear_rademacher_complexity_bound, finite_l1_quadratic_rademacher_coord_bound, finite_l1_quadratic_rademacher_coord_energy_bound, …)_
  ◆ `l2NormSq` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:13`  _(also used by 179: matrixRowVec_norm_sq, offDiagCoeffVec_norm_sq_le_frobenius, offDiagCoeffVec_norm_sq_integral_le_frobenius, …)_
  ◆ `IsSparse` — def · `Statlib/HighDim/Vocabulary/Sparse.lean:36`  _(also used by 37: threshold_head_quadratic_remainder_abs_from_bilinear_l2_tail, subgaussian_l1_shell_localized_centered_tail_from_sparse_approximation_cover, subgaussian_l1_shell_localized_centered_tail_from_sparse_approximation_cover_absorbed, …)_
  ...
  ▣ `SatisfiesL1RSE` — structure · `Statlib/HighDim/Vocabulary/DesignMatrix.lean:159`  _(also used by 9: l1RSE_of_tolerance_dominates, subgaussian_design_l1RSE_from_final_tau_eps_cover_budget_named_event, subgaussian_design_l1RSE_from_final_tau_eps_cover_budget, …)_
            ...
            · `euclidean_norm_sq` — lemma · `Statlib/HighDim/Vocabulary/Norms.lean:89`  _(also used by 25: matrixRowVec_norm_sq, offDiagCoeffVec_norm_sq_le_frobenius, offDiagCoeffVec_norm_sq_integral_le_frobenius, …)_
        ...
        · `sample_quadratic_l2NormSq_div_scaled_vector_eq` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:3998`  _(also used by 1: sparse_l1_lower_of_unit_sparse_l1_lower)_
            ...
            ◆ `toEuclidean` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:109`  _(also used by 15: sampleSecondMoment_unit_direction_lower_tail_double_sum, hermitian_norm_le_two_net_sup, sample_covariance_quadratic_eq_centered_projection_sum, …)_
            ...
            · `euclidean_norm_eq` — lemma · `Statlib/HighDim/Vocabulary/Norms.lean:95`  _(also used by 4: log_covering_number_sparse, extendByEquiv_norm, nuclear_norm_le_sqrt_rank_mul_frobenius, …)_
            ★ `covering_number_sparse_ball` — theorem · `Statlib/HighDim/Geometry/CoveringNumbers.lean:477`  _(also used by 2: subgaussian_rip_tail, subgaussian_rip_tail_anisotropic)_
            · `l1Norm_nonneg` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1162`  _(also used by 2: sparse_head_tail_l1_l2_controls, exists_sparse_head_tail_l1_l2_controls)_
            · `l1Norm_smul` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1330`  _(also used by 1: l1_shell_normalized_l2_l1_cap_of_dyadic_lower)_
            · `l1Norm_inv_smul_eq_one` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1340`
            · `euclidean_norm_toEuclidean_le_l1Norm` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:869`  _(also used by 1: sparse_euclidean_cover_to_l1_cover)_
            · `sparse_l1Norm_of_euclidean_le_sqrt_s_mul_norm` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:813`  _(also used by 2: sparse_euclidean_cover_to_l1_cover, nuclear_norm_le_sqrt_rank_mul_frobenius)_
            · `l1Norm_sub_triangle` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1315`  _(also used by 2: cover_center_l1_bound_from_l2_radius, matrix_entrywise_good_to_radius_fluctuation_two_caps)_
            · `l1Norm_sub_comm` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1308`
            · `normalized_l1_distance_le_two_mul` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1350`
            · `normalized_sparse_euclidean_cover_to_unit_l1_cover` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1413`
            · `exists_normalized_sparse_l1_cover` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1505`
            · `exists_l1Norm_eq_one_of_pos` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1546`
            · `localized_l1_cover_from_sparse_approximation` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1560`  _(also used by 1: subgaussian_l1_shell_localized_centered_tail_from_sparse_approximation_cover)_
            · `exists_localized_l1_cover_from_sparse_ball` — lemma · `Statlib/HighDim/Geometry/CoveringNumbers.lean:1596`  _(also used by 1: subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_sparse_ball_oracle_certificate)_
            ★ `subgaussian_l1_shell_localized_centered_tail_from_sparse_ball_approximation_cover` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:4596`
          ★ `subgaussian_l1_shell_localized_centered_tail_from_sparse_ball_approximation_cover_absorbed` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:4782`
        ★ `subgaussian_l1_shell_localized_centered_tail_from_sparse_ball_oracle_final_rate` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:4888`  _(also used by 1: subgaussian_l1_shell_localized_centered_quadratic_deviation_tail_from_sparse_ball_oracle_certificate)_
        ...
        · `l1_shell_centered_deviation_tail_from_normalized_large_l2_tail` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:3353`  _(also used by 2: subgaussian_l1_shell_centered_quadratic_deviation_tail_from_sparse_oracle_final_rate, subgaussian_l1_shell_centered_quadratic_deviation_tail_named_event_from_entrywise_l1_cover)_
      ★ `subgaussian_l1_shell_centered_quadratic_deviation_tail_from_sparse_ball_oracle_final_rate` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:4979`
      ...
      · `l1_shell_lower_tail_from_centered_deviation_tail` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:554`  _(also used by 2: subgaussian_l1_shell_sample_covariance_lower_tail_from_sparse_oracle_final_rate, subgaussian_design_l1RSE_from_final_tau_eps_cover_budget_named_event)_
    ★ `subgaussian_l1_shell_sample_covariance_lower_tail_from_sparse_ball_oracle_final_rate` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:5068`
      · `l1_lower_of_unit_l1_lower` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:5418`
    · `l1_lower_bad_event_subset_unit_l1_shell_bad_event` — lemma · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:5518`  _(also used by 2: subgaussian_sample_covariance_l1_lower_from_sparse_oracle_final_rate, subgaussian_design_l1RSE_from_final_tau_eps_cover_budget_named_event)_
  ★ `subgaussian_sample_covariance_l1_lower_from_sparse_ball_oracle_final_rate` — theorem · `Statlib/HighDim/CovarianceMatrix/L1QuadraticProcess.lean:6639`
    ★ `l1RSE_of_half_covariance_l1_lower` — theorem · `Statlib/HighDim/Regression/L1RSEFromCovariance.lean:43`
  ★ `l1RSE_probability_from_lower_event` — theorem · `Statlib/HighDim/Regression/L1RSEFromCovariance.lean:75`  _(also used by 3: subgaussian_design_l1RSE_from_final_tau_eps_cover_budget_named_event, subgaussian_design_l1RSE_from_coordinate_tail_rates, subgaussian_design_l1RSE_from_sparse_oracle_final_rate)_
★ `subgaussian_design_l1RSE_from_sparse_ball_oracle_final_rate` — theorem · `Statlib/HighDim/Regression/L1RSEFromCovariance.lean:294` **← headline**

> Closure has 91 declarations — diagram omitted (cap 60).
