...
Root: **lasso_oracle_l1** (theorem) `Statlib/HighDim/LassoOracle.lean:111` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ▣ `SatisfiesRE` — structure · `Statlib/Vocabulary/DesignMatrix.lean:43`  _(also used by 3: lasso_oracle_prediction, lasso_oracle_l2, rip_implies_re)_
...
★ `lasso_oracle_l1` — theorem · `Statlib/HighDim/LassoOracle.lean:111` **← headline**
