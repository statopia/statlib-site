# Proof narrative — lasso_oracle_prediction

Root: **lasso_oracle_prediction** (theorem) `Statlib/HighDim/LassoOracle.lean:94` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ▣ `SatisfiesRE` — structure · `Statlib/Vocabulary/DesignMatrix.lean:43`  _(also used by 3: lasso_oracle_l1, lasso_oracle_l2, rip_implies_re)_
  ...
  ◆ `IsLassoSolution` — def · `Statlib/HighDim/LassoOracle.lean:50`  _(also used by 4: lasso_basic_inequality, lasso_cone_condition, lasso_oracle_l1, …)_
★ `lasso_oracle_prediction` — theorem · `Statlib/HighDim/LassoOracle.lean:94` **← headline**
