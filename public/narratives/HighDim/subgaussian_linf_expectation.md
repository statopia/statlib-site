...
Root: **subgaussian_linf_expectation** (theorem) `Statlib/HighDim/SubGaussianMax.lean:52` · topic `HighDim`
...
★ `subgaussian_linf_expectation` — theorem · `Statlib/HighDim/SubGaussianMax.lean:52` **← headline**
