...
Root: **restrictByEquiv_subgaussian** (lemma) `Statlib/HighDim/Geometry/RIPConstruction.lean:450` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  · `extendByEquiv_norm` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:376`  _(also used by 2: restrictByEquiv_norm_of_support, subgaussian_rip_tail)_
  ...
  · `restrictByEquiv_inner_eq` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:420`  _(also used by 1: restricted_sample_deviation_quadratic)_
· `restrictByEquiv_subgaussian` — lemma · `Statlib/HighDim/Geometry/RIPConstruction.lean:450` **← headline**
