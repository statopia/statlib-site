...
Root: **offdiag_hanson_wright_tail_high_of_const_decoupling_and_decoupled_tail** (theorem) `Statlib/HighDim/Concentration/HansonWright.lean:3805` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ★ `zeroDiag_centered_quadratic_form_tail_high_of_const_decoupling_and_decoupled_tail` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:2959`  _(also used by 1: zeroDiag_centered_quadratic_form_tail_high_of_const_decoupling_absorb)_
★ `offdiag_hanson_wright_tail_high_of_const_decoupling_and_decoupled_tail` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:3805` **← headline**
