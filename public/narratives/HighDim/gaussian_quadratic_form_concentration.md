# Proof narrative — gaussian_quadratic_form_concentration

Root: **gaussian_quadratic_form_concentration** (theorem) `Statlib/HighDim/Concentration/GaussianQuadraticForm.lean:14` · topic `HighDim`
Closure: 63 declarations across 11 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ▣ `HasMean` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:83`  _(also used by 112: frobenius_norm_sq_subgaussian_concentration, coord_mul_subexponential_exists_of_indep, coord_mul_scaled_subexponential_exists_of_indep, …)_
  ...
  ▣ `IsSubGaussianVector` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:52`  _(also used by 162: frobenius_norm_sq_subgaussian_concentration, decoupledOffDiagQuadForm_const_right_subgaussian, decoupledOffDiagQuadForm_const_right_abs_tail_real, …)_
  ◆ `frobeniusNormSq` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:105`  _(also used by 42: frobenius_norm_sq_subgaussian_concentration, frobeniusNormSq_zeroDiagMatrix_le, frobeniusNormSq_nonneg, …)_
  ▣ `HansonWrightScaleConditions` — structure · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:67`  _(also used by 1: frobenius_norm_sq_subgaussian_concentration)_
  ◆ `quadForm` — noncomputable def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:15`  _(also used by 18: frobenius_norm_sq_subgaussian_concentration, zeroDiag_centered_quadratic_form_tail_high_of_decoupling_and_decoupled_tail, zeroDiag_centered_quadratic_form_tail_high_of_const_decoupling_and_decoupled_tail, …)_
  ◆ `zeroDiagMatrix` — def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:52`  _(also used by 31: frobenius_norm_sq_subgaussian_concentration, offDiagCoeff_eq_zeroDiagMatrix_mulVec, offDiagCoeff_norm_le_zeroDiag, …)_
  ◆ `decoupledOffDiagQuadForm` — noncomputable def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:33`  _(also used by 43: frobenius_norm_sq_subgaussian_concentration, decoupledOffDiagQuadForm_eq_sum_coeff, decoupledOffDiagQuadForm_eq_inner_coeff, …)_
          · `measure_event_le_ofReal_of_one_le` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1495`
            ...
            · `offDiagQuadForm_eq_zero_of_entries` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:280`  _(also used by 2: frobenius_norm_sq_subgaussian_concentration, zeroDiag_centered_quadratic_form_tail_high_of_offdiag_entries_zero)_
      ...
      ★ `hanson_wright_tail_of_const_decoupling_scale_conditions` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:4577`  _(also used by 1: frobenius_norm_sq_subgaussian_concentration)_
  ...
  ★ `hanson_wright_isotropic` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:5398`
★ `gaussian_quadratic_form_concentration` — theorem · `Statlib/HighDim/Concentration/GaussianQuadraticForm.lean:14` **← headline**

> Closure has 63 declarations — diagram omitted (cap 60).
