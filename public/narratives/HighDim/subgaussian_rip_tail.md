# Proof narrative — subgaussian_rip_tail

Root: **subgaussian_rip_tail** (theorem) `Statlib/HighDim/RIPConstruction.lean:50` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ◆ `SatisfiesRIP` — def · `Statlib/Vocabulary/DesignMatrix.lean:63`  _(also used by 2: subgaussian_rip_sample_complexity, rip_implies_re)_
★ `subgaussian_rip_tail` — theorem · `Statlib/HighDim/RIPConstruction.lean:50` **← headline**
