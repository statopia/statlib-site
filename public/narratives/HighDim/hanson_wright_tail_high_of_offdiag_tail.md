...
Root: **hanson_wright_tail_high_of_offdiag_tail** (theorem) `Statlib/HighDim/Concentration/HansonWright.lean:4118` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  · `subgaussian_vector_coord` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1340`  _(also used by 15: coord_mul_subexponential_exists_of_indep, coord_sq_centered_mgf_bound, weighted_coord_sq_centered_sum_tail_explicit, …)_
  ...
  · `offDiagQuadForm_integrable_of_coord_sq_integrable` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1269`  _(also used by 1: hanson_wright_tail_high_of_offdiag_tail_weakened)_
    ...
    · `matrix_entry_abs_le_l2_opNorm` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:349`  _(also used by 1: diagPartMatrix_norm_le)_
    ...
    · `coord_sq_centered_scaled_subexponential_explicit_of_range` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:2095`  _(also used by 2: weighted_coord_sq_centered_sum_tail_explicit, subgaussian_norm_sq_subexponential)_
  ...
  ★ `diag_hanson_wright_tail_high` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:3889`  _(also used by 1: hanson_wright_tail_high_of_offdiag_tail_weakened)_
    ...
    · `offDiagQuadForm_integral_eq_zero_of_indep` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1282`  _(also used by 1: offdiag_tail_of_zeroDiag_centered_quad_tail)_
  · `offDiagQuadForm_centered_eq_self_of_indep` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1327`  _(also used by 1: hanson_wright_tail_high_of_offdiag_tail_weakened)_
        · `quadForm_eq_diag_add_offdiag` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:235`  _(also used by 1: quadForm_zeroDiagMatrix_eq_offDiagQuadForm)_
  ...
  · `quadForm_centered_tail_le_two_mul_of_diag_offdiag_tail_bounds` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1794`  _(also used by 1: hanson_wright_tail_high_of_offdiag_tail_weakened)_
★ `hanson_wright_tail_high_of_offdiag_tail` — theorem · `Statlib/HighDim/Concentration/HansonWright.lean:4118` **← headline**
