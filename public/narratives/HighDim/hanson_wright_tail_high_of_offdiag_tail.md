...
Reading order (foundations first, headline last):
  ...
  ▣ `HasMean` — structure · `Statlib/HighDim/Vocabulary/RandomVector.lean:83`  _(also used by 121: frobenius_norm_sq_subgaussian_concentration, gaussian_quadratic_form_concentration, coord_mul_subexponential_exists_of_indep, …)_
  ...
  ◆ `frobeniusNormSq` — noncomputable def · `Statlib/HighDim/Vocabulary/Norms.lean:105`  _(also used by 51: frobenius_norm_sq_subgaussian_concentration, gaussian_quadratic_form_concentration, frobeniusNormSq_zeroDiagMatrix_le, …)_
  ...
  ◆ `quadForm` — noncomputable def · `Statlib/HighDim/Vocabulary/QuadraticForms.lean:15`  _(also used by 29: frobenius_norm_sq_subgaussian_concentration, gaussian_quadratic_form_concentration, quadForm_zeroDiagMatrix_eq_offDiagQuadForm, …)_
