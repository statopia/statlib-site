...
Root: **coord_sq_centered_mgf_bound** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:1931` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  · `subgaussian_vector_coord` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1341`  _(also used by 18: coord_mul_subexponential_exists_of_indep, coord_sq_centered_mgf_bound_explicit, coord_sq_centered_scaled_exp_integrable, …)_
    ...
    ★ `subexp_mgf_le_of_sq_subgaussian_explicit` — theorem · `Statlib/StatFoundation/RandomVariable/SubExponential/subexp_mgf_le_of_sq_subgaussian.lean:73`  _(also used by 2: coord_sq_centered_mgf_bound_explicit, scalar_sq_centered_subexponential_explicit)_
  ★ `subexp_mgf_le_of_sq_subgaussian` — theorem · `Statlib/StatFoundation/RandomVariable/SubExponential/subexp_mgf_le_of_sq_subgaussian.lean:1228`
· `coord_sq_centered_mgf_bound` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1931` **← headline**
