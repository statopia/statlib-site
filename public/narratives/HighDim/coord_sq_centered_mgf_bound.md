...
Root: **coord_sq_centered_mgf_bound** (lemma) `Statlib/HighDim/Concentration/HansonWright.lean:1930` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  · `subgaussian_vector_coord` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1340`  _(also used by 18: coord_mul_subexponential_exists_of_indep, coord_sq_centered_mgf_bound_explicit, coord_sq_centered_scaled_exp_integrable, …)_
...
· `coord_sq_centered_mgf_bound` — lemma · `Statlib/HighDim/Concentration/HansonWright.lean:1930` **← headline**
