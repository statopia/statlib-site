# Proof narrative — sampleCovariance_concentration

Root: **sampleCovariance_concentration** (theorem) `Statlib/HighDim/SampleCovariance.lean:73` · topic `HighDim`
...
Reading order (foundations first, headline last):
  ...
  ◆ `sampleSecondMoment` — noncomputable def · `Statlib/HighDim/SampleCovariance.lean:41`  _(also used by 3: sampleSecondMoment_unbiased, sampleCovariance_confidence, pca_eigvec_perturbation)_
★ `sampleCovariance_concentration` — theorem · `Statlib/HighDim/SampleCovariance.lean:73` **← headline**
...
flowchart TD
  ...
  n4["★ sampleCovariance_concentration"]
  n4 --> n0
  n4 --> n1
  n4 --> n2
  n4 --> n3
