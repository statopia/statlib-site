# Proof narrative — gaussian_poincare_of_integral_bound

Root: **gaussian_poincare_of_integral_bound** (theorem) `Statlib/Gaussian/Poincare.lean:34` · topic `Gaussian`
...
★ `gaussian_poincare_of_integral_bound` — theorem · `Statlib/Gaussian/Poincare.lean:34` **← headline**
...
flowchart TD
  n0["◆ stdGaussian"]
  n1["◆ stdGaussianPi"]
  n2["★ gaussian_poincare_of_integral_bound"]
  n1 --> n0
  n2 --> n1
  class n2 headline;
