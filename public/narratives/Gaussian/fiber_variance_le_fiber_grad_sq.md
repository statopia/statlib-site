# Proof narrative — fiber_variance_le_fiber_grad_sq

Root: **fiber_variance_le_fiber_grad_sq** (private lemma) `Statlib/Gaussian/Poincare.lean:613` · topic `Gaussian`
...
Reading order (foundations first, headline last):
  ...
  ★ `gaussian_poincare_1d_core` — theorem · `Statlib/Gaussian/Poincare.lean:441`  _(also used by 2: gaussian_poincare_1d, condVar_le_condExp_gradf_sq_ae_succ)_
· `fiber_variance_le_fiber_grad_sq` — private lemma · `Statlib/Gaussian/Poincare.lean:613` **← headline**
...
flowchart TD
  ...
  n53["· fiber_variance_le_fiber_grad_sq"]
  n2 --> n1
  n3 --> n2
  n3 --> n0
  n4 --> n3
