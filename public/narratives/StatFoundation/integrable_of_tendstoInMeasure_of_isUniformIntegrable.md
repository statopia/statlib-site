# Proof narrative — integrable_of_tendstoInMeasure_of_isUniformIntegrable

Root: **integrable_of_tendstoInMeasure_of_isUniformIntegrable** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:225` · topic `StatFoundation`
...
★ `integrable_of_tendstoInMeasure_of_isUniformIntegrable` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:225` **← headline**
...
flowchart TD
  ...
  n2["★ integrable_of_tendstoInMeasure_of_isUniformIntegrable"]
  n1 --> n0
  n2 --> n1
  class n2 headline;
