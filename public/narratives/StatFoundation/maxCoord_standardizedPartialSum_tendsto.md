# Proof narrative — maxCoord_standardizedPartialSum_tendsto

Root: **maxCoord_standardizedPartialSum_tendsto** (theorem) `Statlib/StatFoundation/Convergence/CentralLimitTheorem/MaxType.lean:241` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ◆ `maxCoord` — noncomputable def · `Statlib/StatFoundation/Vocabulary/MaxType.lean:34`  _(also used by 10: smoothMax_bounds_max_log_card, maxCoord_measurable, maxCoord_lipschitz_ineq, …)_
  ...
  ★ `tendstoInDistribution_toLp_of_finiteLinearCombination_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/CramerWold.lean:409`  _(also used by 4: tendstoInDistribution_toLp_iff_finiteLinearCombination_real, tendstoInDistribution_toLp_of_finiteLinearCombination_remainder_tendstoInMeasure_real, standardizedPartialSumVec_tendstoInDistribution, …)_
    ★ `maxCoord_lipschitz` — theorem · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/MaxType.lean:45`  _(also used by 1: maxCoord_lipschitz_ineq)_
  ...
  ★ `tendstoInDistribution_maxCoord_of_tendstoInDistribution` — theorem · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/MaxType.lean:192`
★ `maxCoord_standardizedPartialSum_tendsto` — theorem · `Statlib/StatFoundation/Convergence/CentralLimitTheorem/MaxType.lean:241` **← headline**
...
flowchart TD
  ...
  n21["★ maxCoord_lipschitz"]
  n22["★ continuous_mapping"]
  n23["★ tendstoInDistribution_maxCoord_of_tendstoInDistribution"]
  n24["★ maxCoord_standardizedPartialSum_tendsto"]
  n3 --> n2
  n11 --> n10
  n12 --> n9
  n12 --> n11
