# Proof narrative — isUniformIntegrable_average_real

Root: **isUniformIntegrable_average_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:293` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `isUniformIntegrableInLp_average_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:284`
★ `isUniformIntegrable_average_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:293` **← headline**
...
flowchart TD
  ...
  n2["★ isUniformIntegrableInLp_average_real"]
  n3["★ isUniformIntegrable_average_real"]
  n1 --> n0
  n2 --> n0
  n3 --> n1
  n3 --> n2
