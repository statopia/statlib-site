# Proof narrative — isLittleOInProbability_mul_of_isBigOInProbability_tendsto_zero_left

Root: **isLittleOInProbability_mul_of_isBigOInProbability_tendsto_zero_left** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/SlutskyProduct.lean:45` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `isLittleOInProbability_mul_of_inProbabilityConvergence_zero_left` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/SlutskyProduct.lean:16`  _(also used by 1: z_estimator_linearization_from_mvt)_
...
★ `isLittleOInProbability_mul_of_isBigOInProbability_tendsto_zero_left` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/SlutskyProduct.lean:45` **← headline**
...
flowchart TD
  ...
  n8["★ isLittleOInProbability_mul_isBigOInProbability"]
  n9["★ isLittleOInProbability_mul_of_inProbabilityConvergence_zero_left"]
  ...
  n14["★ isLittleOInProbability_mul_of_isBigOInProbability_tendsto_zero_left"]
  n3 --> n2
  n6 --> n1
  n6 --> n5
  n7 --> n3
