# Proof narrative — isTightMeasureSet_range_map_of_isLittleOInProbability_rate_isBigO_one_proper

Root: **isTightMeasureSet_range_map_of_isLittleOInProbability_rate_isBigO_one_proper** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/Tightness.lean:475` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `isTightMeasureSet_range_map_of_isBoundedInProbability_proper` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/Tightness.lean:360`  _(also used by 2: isTightMeasureSet_range_map_of_isBigOInProbability_tendsto_zero_proper, isTightMeasureSet_range_map_of_isBigOInProbability_rate_isBigO_one_proper)_
...
★ `isTightMeasureSet_range_map_of_isLittleOInProbability_rate_isBigO_one_proper` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/Tightness.lean:475` **← headline**
...
flowchart TD
  ...
  n7["★ isTightMeasureSet_range_map_of_isBoundedInProbability_proper"]
  ...
  n12["★ isTightMeasureSet_range_map_of_isLittleOInProbability_rate_isBigO_one_proper"]
  n2 --> n1
  n5 --> n4
  n6 --> n1
  n6 --> n3
