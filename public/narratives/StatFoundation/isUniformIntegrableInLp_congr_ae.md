# Proof narrative — isUniformIntegrableInLp_congr_ae

Root: **isUniformIntegrableInLp_congr_ae** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:30` · topic `StatFoundation`
...
★ `isUniformIntegrableInLp_congr_ae` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:30` **← headline**
...
flowchart TD
  ...
  n1["★ isUniformIntegrableInLp_congr_ae"]
  n1 --> n0
  class n1 headline;
