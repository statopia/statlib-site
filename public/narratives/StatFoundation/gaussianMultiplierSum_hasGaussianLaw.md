# Proof narrative — gaussianMultiplierSum_hasGaussianLaw

Root: **gaussianMultiplierSum_hasGaussianLaw** (theorem) `Statlib/StatFoundation/Convergence/Resampling/BootstrapInterface.lean:543` · topic `StatFoundation`
...
★ `gaussianMultiplierSum_hasGaussianLaw` — theorem · `Statlib/StatFoundation/Convergence/Resampling/BootstrapInterface.lean:543` **← headline**
...
flowchart TD
  ...
  n1["◆ multiplierSumVec"]
  n2["★ gaussianMultiplierSum_hasGaussianLaw"]
  n2 --> n0
  n2 --> n1
  class n2 headline;
