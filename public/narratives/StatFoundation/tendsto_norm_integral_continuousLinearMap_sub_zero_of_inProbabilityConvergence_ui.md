# Proof narrative — tendsto_norm_integral_continuousLinearMap_sub_zero_of_inProbabilityConvergence_ui

Root: **tendsto_norm_integral_continuousLinearMap_sub_zero_of_inProbabilityConvergence_ui** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:187` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `inLpConvergence_one_of_inProbabilityConvergence_of_isUniformIntegrable` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:150`  _(also used by 4: tendsto_integral_of_inProbabilityConvergence_of_isUniformIntegrable, tendsto_norm_integral_sub_zero_of_inProbabilityConvergence_of_isUniformIntegrable, tendsto_integral_continuousLinearMap_of_inProbabilityConvergence_of_isUniformIntegrable, …)_
    ★ `inLpConvergence_continuousLinearMap` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:103`  _(also used by 1: tendsto_integral_continuousLinearMap_of_inLpConvergence_one)_
    ...
    ★ `tendsto_norm_integral_sub_zero_of_inLpConvergence_one` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:54`  _(also used by 1: tendsto_norm_integral_sub_zero_of_inProbabilityConvergence_of_isUniformIntegrable)_
  ★ `tendsto_norm_integral_continuousLinearMap_sub_zero_of_inLpConvergence_one` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:152`
★ `tendsto_norm_integral_continuousLinearMap_sub_zero_of_inProbabilityConvergence_ui` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:187` **← headline**
...
flowchart TD
  ...
  n14["★ inLpConvergence_continuousLinearMap"]
  n15["★ tendsto_integral_of_inLpConvergence_one"]
  n16["★ tendsto_integral_sub_zero_of_inLpConvergence_one"]
  n17["★ tendsto_norm_integral_sub_zero_of_inLpConvergence_one"]
  n18["★ tendsto_norm_integral_continuousLinearMap_sub_zero_of_inLpConvergence_one"]
  n19["★ tendsto_norm_integral_continuousLinearMap_sub_zero_of_inProbabilityConvergence_ui"]
  n1 --> n0
  n3 --> n2
  n5 --> n3
  n5 --> n4
