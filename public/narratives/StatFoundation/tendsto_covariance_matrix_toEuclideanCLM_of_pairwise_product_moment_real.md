# Proof narrative — tendsto_covariance_matrix_toEuclideanCLM_of_pairwise_product_moment_real

Root: **tendsto_covariance_matrix_toEuclideanCLM_of_pairwise_product_moment_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1087` · topic `StatFoundation`
...
★ `tendsto_covariance_matrix_toEuclideanCLM_of_pairwise_product_moment_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1087` **← headline**
...
flowchart TD
  ...
  n4["★ tendsto_covariance_of_tendsto_integral_mul_real"]
  n5["★ tendsto_covariance_matrix_toEuclideanCLM_of_pairwise_product_moment_real"]
  n2 --> n0
  n2 --> n1
  n3 --> n2
  n5 --> n3
