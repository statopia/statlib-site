# Proof narrative — tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_right

Root: **tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_right** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:631` · topic `StatFoundation`
...
★ `tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_right` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:631` **← headline**
...
flowchart TD
  ...
  n9["★ tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_right"]
  n3 --> n1
  n3 --> n2
  n4 --> n0
  n4 --> n1
