# Proof narrative — tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real

Root: **tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2657` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `inLpConvergence_two_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2469`  _(also used by 13: tendsto_integral_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two, tendsto_integral_mul_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, tendsto_covariance_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, …)_
      ...
      ★ `tendsto_norm_sub_matrix_toEuclideanCLM_zero_of_forall_entries_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:989`  _(also used by 1: tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_pairwise_covariance_real)_
    ★ `tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_pairwise_integral_mul_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1798`
  ...
  ★ `tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2046`
★ `tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2657` **← headline**
...
flowchart TD
  ...
  n15["★ tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_pairwise_integral_mul_real"]
  ...
  n20["★ tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_forall_inLpConvergence_two_real"]
  n21["★ tendsto_norm_sub_secondMoment_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real"]
  n2 --> n1
  n3 --> n0
  n5 --> n2
  n5 --> n4
