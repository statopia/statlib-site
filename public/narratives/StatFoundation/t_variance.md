# Proof narrative — t_variance

Root: **t_variance** (theorem) `Statlib/StatFoundation/Probability/TDistribution.lean:1194` · topic `StatFoundation`
...
★ `t_variance` — theorem · `Statlib/StatFoundation/Probability/TDistribution.lean:1194` **← headline**
