# Proof narrative — isUniformIntegrableInLp_finite

Root: **isUniformIntegrableInLp_finite** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:37` · topic `StatFoundation`
...
★ `isUniformIntegrableInLp_finite` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:37` **← headline**
...
flowchart TD
  ...
  n1["★ isUniformIntegrableInLp_finite"]
  n1 --> n0
  class n1 headline;
