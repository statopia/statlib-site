# Proof narrative — tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real

Root: **tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2862` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `inLpConvergence_two_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2469`  _(also used by 13: tendsto_integral_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two, tendsto_integral_mul_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, tendsto_covariance_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, …)_
    ...
    ★ `tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_pairwise_covariance_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1033`  _(also used by 1: tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_pairwise_product_moment_real)_
    ...
    ★ `tendsto_pairwise_covariance_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2222`  _(also used by 4: tendsto_covariance_matrix_toEuclideanCLM_of_forall_inLpConvergence_two_real, tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inLpConvergence_two_real, tendsto_covarianceBilin_map_toLp_basisFun_of_forall_inLpConvergence_two_real, …)_
  ★ `tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2344`
★ `tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2862` **← headline**
...
flowchart TD
  ...
  n13["★ tendsto_matrix_l2_opNorm_sub_zero_of_forall_entries_real"]
  n14["★ tendsto_norm_sub_matrix_toEuclideanCLM_zero_of_forall_entries_real"]
  n15["★ tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_pairwise_covariance_real"]
  n16["★ tendsto_covariance_of_tendsto_integral_mul_real"]
  n17["★ inLpConvergence_one_of_inLpConvergence_two"]
  n18["★ tendsto_integral_of_inLpConvergence_one"]
  n19["★ tendsto_integral_of_inLpConvergence_two"]
  ...
  n23["★ tendsto_covariance_of_inLpConvergence_two_real"]
  n24["★ tendsto_pairwise_covariance_of_forall_inLpConvergence_two_real"]
  n25["★ tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inLpConvergence_two_real"]
  n26["★ tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real"]
  n2 --> n1
  n3 --> n0
  n5 --> n2
  n5 --> n4
