# Proof narrative — tendsto_covarianceBilin_map_toLp_apply_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real

Root: **tendsto_covarianceBilin_map_toLp_apply_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2960` · topic `StatFoundation`
Closure: 31 declarations across 4 files. Generated from `proof_graph.json` — no files were moved.
...
Reading order (foundations first, headline last):
  ...
  ★ `inLpConvergence_two_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2469`  _(also used by 13: tendsto_integral_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two, tendsto_integral_mul_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, tendsto_covariance_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, …)_
    ...
    ★ `tendsto_covarianceBilin_map_toLp_apply_of_pairwise_covariance_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1267`  _(also used by 1: tendsto_covarianceBilin_map_toLp_apply_of_pairwise_product_moment_real)_
  ...
  ★ `tendsto_covarianceBilin_map_toLp_apply_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2430`
★ `tendsto_covarianceBilin_map_toLp_apply_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2960` **← headline**
...
flowchart TD
  ...
  n18["★ inner_covariance_matrix_toEuclideanCLM_eq_covarianceBilin_map_toLp_real"]
  n19["★ tendsto_covarianceBilin_map_toLp_apply_of_pairwise_covariance_real"]
  n20["★ tendsto_covariance_of_tendsto_integral_mul_real"]
  n21["★ inLpConvergence_one_of_inLpConvergence_two"]
  n22["★ tendsto_integral_of_inLpConvergence_one"]
  n23["★ tendsto_integral_of_inLpConvergence_two"]
  n24["★ inLpConvergence_iff_tendsto_Lp_toLp"]
  n25["★ tendsto_Lp_toLp_of_inLpConvergence"]
  n26["★ tendsto_integral_mul_of_inLpConvergence_two_real"]
  n27["★ tendsto_covariance_of_inLpConvergence_two_real"]
  n28["★ tendsto_pairwise_covariance_of_forall_inLpConvergence_two_real"]
  n29["★ tendsto_covarianceBilin_map_toLp_apply_of_forall_inLpConvergence_two_real"]
  n30["★ tendsto_covarianceBilin_map_toLp_apply_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real"]
  n2 --> n1
  n3 --> n0
  n5 --> n2
  n5 --> n4
