# Proof narrative — bernstein_martingale_sum_meas_abs_ge_le_two_exp

Root: **bernstein_martingale_sum_meas_abs_ge_le_two_exp** (theorem) `Statlib/StatFoundation/Concentration/ExponentialType/bernstein_martingale_sum_meas_abs_ge_le_two_exp.lean:15` · topic `StatFoundation`
...
flowchart TD
  n0["★ pullout_bound"]
  n1["★ bernstein_martingale_sum_meas_ge_le_exp"]
  n2["★ bernstein_martingale_sum_meas_abs_ge_le_two_exp"]
  n1 --> n0
  n2 --> n1
  class n2 headline;
