# Proof narrative — tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real

Root: **tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2908` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `inLpConvergence_two_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2469`  _(also used by 13: tendsto_integral_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two, tendsto_integral_mul_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, tendsto_covariance_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, …)_
    ...
    ★ `tendsto_inner_covariance_matrix_toEuclideanCLM_of_pairwise_covariance_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1307`  _(also used by 1: tendsto_inner_covariance_matrix_toEuclideanCLM_of_pairwise_product_moment_real)_
    ...
    ★ `tendsto_pairwise_covariance_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2222`  _(also used by 4: tendsto_covariance_matrix_toEuclideanCLM_of_forall_inLpConvergence_two_real, tendsto_norm_sub_covariance_matrix_toEuclideanCLM_zero_of_forall_inLpConvergence_two_real, tendsto_covarianceBilin_map_toLp_basisFun_of_forall_inLpConvergence_two_real, …)_
  ★ `tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2386`
★ `tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2908` **← headline**
...
flowchart TD
  ...
  n17["★ tendsto_covariance_matrix_toEuclideanCLM_of_pairwise_covariance_real"]
  n18["★ tendsto_inner_covariance_matrix_toEuclideanCLM_of_pairwise_covariance_real"]
  n19["★ tendsto_covariance_of_tendsto_integral_mul_real"]
  n20["★ inLpConvergence_one_of_inLpConvergence_two"]
  n21["★ tendsto_integral_of_inLpConvergence_one"]
  n22["★ tendsto_integral_of_inLpConvergence_two"]
  n23["★ inLpConvergence_iff_tendsto_Lp_toLp"]
  n24["★ tendsto_Lp_toLp_of_inLpConvergence"]
  n25["★ tendsto_integral_mul_of_inLpConvergence_two_real"]
  n26["★ tendsto_covariance_of_inLpConvergence_two_real"]
  n27["★ tendsto_pairwise_covariance_of_forall_inLpConvergence_two_real"]
  n28["★ tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inLpConvergence_two_real"]
  n29["★ tendsto_inner_covariance_matrix_toEuclideanCLM_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real"]
  n2 --> n1
  n3 --> n0
  n5 --> n2
  n5 --> n4
