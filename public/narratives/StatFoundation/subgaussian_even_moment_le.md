...
Root: **subgaussian_even_moment_le** (theorem) `Statlib/StatFoundation/RandomVariable/SubGaussian/subgaussian_even_moment_le.lean:20` · topic `StatFoundation`
