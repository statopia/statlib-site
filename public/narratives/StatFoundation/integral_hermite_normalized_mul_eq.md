...
Reading order (foundations first, headline last):
  ...
  ◆ `standardReal` — abbrev · `Statlib/StatFoundation/RandomVariable/Gaussian/Standard.lean:31`  _(also used by 70: single_square_law, wald_statistic_asymptotic_chisq1, score_statistic_asymptotic_chisq1, …)_
        · `hasDerivAt_standardGaussianPDFReal` — lemma · `Statlib/StatFoundation/RandomVariable/Gaussian/Standard.lean:178`  _(also used by 2: hasDerivAt_hermite_eval_mul_gaussianPDF, standardReal_ou_mehler_entropy_ibp_pos)_
      ...
      · `standard_stein_identity` — lemma · `Statlib/StatFoundation/RandomVariable/Gaussian/Stein.lean:25`  _(also used by 2: standardReal_integrationByParts_smooth_bddDeriv, standard_stein_identity_of_lipschitz)_
      ...
      · `integrable_aeval_intPolynomial_standard` — lemma · `Statlib/StatFoundation/RandomVariable/Gaussian/Hermite.lean:52`  _(also used by 2: standardReal_ou_mehler_time_hasDerivAt_pos, standardReal_ou_mehler_entropy_derivative_pos)_
