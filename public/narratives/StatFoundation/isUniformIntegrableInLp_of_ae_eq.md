# Proof narrative — isUniformIntegrableInLp_of_ae_eq

Root: **isUniformIntegrableInLp_of_ae_eq** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:21` · topic `StatFoundation`
...
★ `isUniformIntegrableInLp_of_ae_eq` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/UniformIntegrability.lean:21` **← headline**
...
flowchart TD
  ...
  n1["★ isUniformIntegrableInLp_of_ae_eq"]
  n1 --> n0
  class n1 headline;
