# Proof narrative — tendsto_covarianceOperator_map_toLp_inner_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real

Root: **tendsto_covarianceOperator_map_toLp_inner_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2750` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ★ `inLpConvergence_two_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2469`  _(also used by 13: tendsto_integral_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two, tendsto_integral_mul_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, tendsto_covariance_of_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real, …)_
    ...
    ★ `tendsto_covarianceOperator_map_toLp_inner_of_pairwise_integral_mul_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:1874`  _(also used by 1: tendsto_covarianceOperator_map_toLp_toWOT_of_pairwise_integral_mul_real)_
  ...
  ★ `tendsto_covarianceOperator_map_toLp_inner_of_forall_inLpConvergence_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2122`
★ `tendsto_covarianceOperator_map_toLp_inner_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/IntegralConvergence.lean:2750` **← headline**
...
flowchart TD
  ...
  n13["★ inner_continuousLinearMap_apply_eq_sum_basisFun_real"]
  n14["★ memLp_id_map_toLp_of_forall_memLp_two_real"]
  n15["★ covarianceOperator_map_toLp_basisFun_inner_eq_integral_mul_real"]
  n16["★ covarianceOperator_map_toLp_inner_eq_sum_integral_mul_real"]
  n17["★ tendsto_covarianceOperator_map_toLp_inner_of_pairwise_integral_mul_real"]
  n18["★ inLpConvergence_iff_tendsto_Lp_toLp"]
  n19["★ tendsto_Lp_toLp_of_inLpConvergence"]
  n20["★ tendsto_integral_mul_of_inLpConvergence_two_real"]
  n21["★ tendsto_pairwise_integral_mul_of_forall_inLpConvergence_two_real"]
  n22["★ tendsto_covarianceOperator_map_toLp_inner_of_forall_inLpConvergence_two_real"]
  n23["★ tendsto_covarianceOperator_map_toLp_inner_of_forall_inProbabilityConvergence_of_isUniformIntegrableInLp_two_real"]
  n2 --> n1
  n3 --> n0
  n5 --> n2
  n5 --> n4
