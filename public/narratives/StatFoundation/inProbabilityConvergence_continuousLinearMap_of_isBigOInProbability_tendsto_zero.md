# Proof narrative — inProbabilityConvergence_continuousLinearMap_of_isBigOInProbability_tendsto_zero

Root: **inProbabilityConvergence_continuousLinearMap_of_isBigOInProbability_tendsto_zero** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:488` · topic `StatFoundation`
...
Reading order (foundations first, headline last):
  ...
  ◆ `InProbabilityConvergence` — def · `Statlib/StatFoundation/Convergence/AnalysisTools/ConvergenceModes.lean:61`  _(also used by 70: t_test_consistent, tendstoInMeasure_of_inProbabilityConvergence, inProbabilityConvergence_of_tendstoInMeasure, …)_
    ★ `inProbabilityConvergence_lipschitz` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:345`  _(also used by 1: inProbabilityConvergence_norm)_
  ★ `inProbabilityConvergence_continuousLinearMap` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:383`
...
★ `inProbabilityConvergence_continuousLinearMap_of_isBigOInProbability_tendsto_zero` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:488` **← headline**
...
flowchart TD
  ...
  n4["★ inProbabilityConvergence_continuousLinearMap"]
  ...
  n12["★ inProbabilityConvergence_continuousLinearMap_of_isBigOInProbability_tendsto_zero"]
  n2 --> n1
  n3 --> n2
  n3 --> n1
  n4 --> n2
