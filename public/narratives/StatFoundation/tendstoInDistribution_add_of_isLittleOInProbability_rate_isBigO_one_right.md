# Proof narrative — tendstoInDistribution_add_of_isLittleOInProbability_rate_isBigO_one_right

Root: **tendstoInDistribution_add_of_isLittleOInProbability_rate_isBigO_one_right** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:721` · topic `StatFoundation`
...
★ `tendstoInDistribution_add_of_isLittleOInProbability_rate_isBigO_one_right` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:721` **← headline**
...
flowchart TD
  ...
  n8["★ tendstoInDistribution_add_of_isLittleOInProbability_rate_isBigO_one_right"]
  n2 --> n0
  n2 --> n1
  n3 --> n0
  n4 --> n0
