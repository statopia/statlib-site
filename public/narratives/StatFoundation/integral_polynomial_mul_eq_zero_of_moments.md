...
Reading order (foundations first, headline last):
  ...
  ◆ `standardReal` — abbrev · `Statlib/StatFoundation/RandomVariable/Gaussian/Standard.lean:31`  _(also used by 79: single_square_law, wald_statistic_asymptotic_chisq1, score_statistic_asymptotic_chisq1, …)_
    ...
    · `memLp_polynomial_standard` — lemma · `Statlib/StatFoundation/RandomVariable/Gaussian/Standard.lean:144`  _(also used by 4: memLp_aeval_intPolynomial_standard, standardReal_logSobolev_smooth_normalized_finiteFisher, standardPi_logSobolev_smooth_finiteFisher_coord, …)_
