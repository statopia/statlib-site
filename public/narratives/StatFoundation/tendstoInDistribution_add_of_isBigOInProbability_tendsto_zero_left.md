# Proof narrative — tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_left

Root: **tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_left** (theorem) `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:607` · topic `StatFoundation`
...
★ `tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_left` — theorem · `Statlib/StatFoundation/Convergence/AnalysisTools/StochasticOrder/ConvergenceBridges.lean:607` **← headline**
...
flowchart TD
  ...
  n7["★ tendstoInMeasure_congr_left"]
  n8["★ tendstoInDistribution_of_tendstoInMeasure_sub"]
  n9["★ tendstoInDistribution_add_of_isBigOInProbability_tendsto_zero_left"]
  n3 --> n1
  n3 --> n2
  n4 --> n0
  n4 --> n1
