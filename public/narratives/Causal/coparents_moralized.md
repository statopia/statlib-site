# Proof narrative — coparents_moralized

Root: **coparents_moralized** (theorem) `Statlib/Causal/SCM/Theorems.lean:1371` · topic `Causal`
...
★ `coparents_moralized` — theorem · `Statlib/Causal/SCM/Theorems.lean:1371` **← headline**
