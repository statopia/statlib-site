# Proof narrative — non_ancestor_not_parent

Root: **non_ancestor_not_parent** (theorem) `Statlib/Causal/SCM/Theorems.lean:679` · topic `Causal`
...
★ `non_ancestor_not_parent` — theorem · `Statlib/Causal/SCM/Theorems.lean:679` **← headline**
