# Proof narrative — IsLikelihoodArgmax.le

Root: **IsLikelihoodArgmax.le** (lemma) `Statlib/CoxChangePoint/ScoreEquation.lean:80` · topic `CoxChangePoint`
...
Reading order (foundations first, headline last):
  ...
  ◆ `logPartialLikelihood` — noncomputable def · `Statlib/CoxChangePoint/Foundation.lean:104`  _(also used by 5: coxLogPartialLikelihoodRatio, CoxFirstOrderTaylor, Gn, …)_
  ◆ `IsLikelihoodArgmax` — def · `Statlib/CoxChangePoint/ScoreEquation.lean:70`  _(also used by 3: IsLikelihoodArgmax.mem, IsCoxMLE, IsCoxMLE.argmax)_
· `IsLikelihoodArgmax.le` — lemma · `Statlib/CoxChangePoint/ScoreEquation.lean:80` **← headline**
