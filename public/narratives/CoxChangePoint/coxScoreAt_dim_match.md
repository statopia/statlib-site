# Proof narrative — coxScoreAt_dim_match

Root: **coxScoreAt_dim_match** (lemma) `Statlib/CoxChangePoint/CoxLAN.lean:103` · topic `CoxChangePoint`
Closure: 19 declarations across 3 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ▣ `CoxObs` — structure · `Statlib/CoxChangePoint/Foundation.lean:38`  _(also used by 26: TruncSample, benchmark_obs, coxLogPartialLikelihoodRatio, …)_
  ...
  ◆ `coxScoreAt` — noncomputable def · `Statlib/CoxChangePoint/CoxLAN.lean:87`  _(also used by 4: CoxLANExpansionHypothesis, toLANExpansion, CoxFirstOrderTaylor, …)_
· `coxScoreAt_dim_match` — lemma · `Statlib/CoxChangePoint/CoxLAN.lean:103` **← headline**
