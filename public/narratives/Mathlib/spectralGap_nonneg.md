# Proof narrative — spectralGap_nonneg

Root: **spectralGap_nonneg** (lemma) `Statlib/Mathlib/Analysis/DavisKahan.lean:151` · topic `Mathlib`
Closure: 5 declarations across 3 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ◆ `spectralGap` — noncomputable def · `Statlib/Mathlib/Analysis/DavisKahan.lean:127`  _(also used by 2: spectralGap_of_punctured_spectrum_empty, spectralGap_le_dist_of_mem)_
...
· `spectralGap_nonneg` — lemma · `Statlib/Mathlib/Analysis/DavisKahan.lean:151` **← headline**
