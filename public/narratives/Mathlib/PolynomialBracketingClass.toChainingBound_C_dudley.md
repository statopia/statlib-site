# Proof narrative — PolynomialBracketingClass.toChainingBound_C_dudley

Root: **PolynomialBracketingClass.toChainingBound_C_dudley** (lemma) `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:204` · topic `Mathlib`
...
· `PolynomialBracketingClass.toChainingBound_C_dudley` — lemma · `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:204` **← headline**
...
flowchart TD
  ...
  n5["· PolynomialBracketingClass.toChainingBound_C_dudley"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n3 --> n2
