# Proof narrative — polynomialBracketingClass_log_bracketing_le

Root: **polynomialBracketingClass_log_bracketing_le** (theorem) `Statlib/Mathlib/EmpiricalProcess/BracketingIntegralConv.lean:202` · topic `Mathlib`
...
Reading order (foundations first, headline last):
  ...
  ▣ `PolynomialBracketingClass` — structure · `Statlib/Mathlib/EmpiricalProcess/BracketingIntegralConv.lean:164`  _(also used by 13: bound_pos, polynomialBracketingClass_sqrt_log_bracketing_le, polynomialBracketingClass_integrand_pointwise_bound, …)_
★ `polynomialBracketingClass_log_bracketing_le` — theorem · `Statlib/Mathlib/EmpiricalProcess/BracketingIntegralConv.lean:202` **← headline**
...
flowchart TD
  ...
  n5["★ polynomialBracketingClass_log_bracketing_le"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n3 --> n2
