# Proof narrative — PolynomialBracketingClass.toVWConclusion_C

Root: **PolynomialBracketingClass.toVWConclusion_C** (lemma) `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:233` · topic `Mathlib`
...
Reading order (foundations first, headline last):
  ...
  ▣ `ChainingBound` — structure · `Statlib/CoxChangePoint/ChainingRecursion.lean:254`  _(also used by 3: toConclusion, PolynomialBracketingClass.toChainingBound, PolynomialBracketingClass.toVWConclusion)_
· `PolynomialBracketingClass.toVWConclusion_C` — lemma · `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:233` **← headline**
...
flowchart TD
  ...
  n5["▣ ChainingBound"]
  n6["· PolynomialBracketingClass.toVWConclusion_C"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n3 --> n2
