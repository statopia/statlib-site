# Proof narrative — bound_pos

Root: **bound_pos** (lemma) `Statlib/Mathlib/EmpiricalProcess/BracketingIntegralConv.lean:186` · topic `Mathlib`
...
Reading order (foundations first, headline last):
  ...
  ▣ `PolynomialBracketingClass` — structure · `Statlib/Mathlib/EmpiricalProcess/BracketingIntegralConv.lean:164`  _(also used by 13: polynomialBracketingClass_log_bracketing_le, polynomialBracketingClass_sqrt_log_bracketing_le, polynomialBracketingClass_integrand_pointwise_bound, …)_
· `bound_pos` — lemma · `Statlib/Mathlib/EmpiricalProcess/BracketingIntegralConv.lean:186` **← headline**
