# Proof narrative — PolynomialBracketingClass.one_le_dudleyPrefactor

Root: **PolynomialBracketingClass.one_le_dudleyPrefactor** (lemma) `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:128` · topic `Mathlib`
...
Reading order (foundations first, headline last):
  ...
  ◆ `PolynomialBracketingClass.dudleyPrefactor` — def · `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:107`  _(also used by 1: PolynomialBracketingClass.dudleyPrefactor_pos)_
· `PolynomialBracketingClass.one_le_dudleyPrefactor` — lemma · `Statlib/Mathlib/EmpiricalProcess/VWPolynomialClass.lean:128` **← headline**
...
flowchart TD
  ...
  n6["· PolynomialBracketingClass.one_le_dudleyPrefactor"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n3 --> n2
