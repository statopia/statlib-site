# Proof narrative — selector_indicator_uniform_sieve_holder_approximation_rate_of_cover

Root: **selector_indicator_uniform_sieve_holder_approximation_rate_of_cover** (theorem) `Statlib/Nonparametric/Approximation/Holder.lean:498` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ◆ `holderBall` — def · `Statlib/Nonparametric/Vocabulary/FunctionClasses.lean:60`  _(also used by 11: holder_ball_class_approximation_error_self_le_zero, exists_selector_indicator_sieve_holder_approximation_bound_of_finite_measurable_cover, exists_selector_indicator_sieve_holder_approximation_bound, …)_
  ...
  ★ `exists_selector_indicator_sieve_uniform_holder_approximation_rate_of_cover` — theorem · `Statlib/Nonparametric/Approximation/Holder.lean:372`  _(also used by 1: exists_selector_indicator_sieve_uniform_holder_approximation_rate_of_finite_measurable_cover)_
★ `selector_indicator_uniform_sieve_holder_approximation_rate_of_cover` — theorem · `Statlib/Nonparametric/Approximation/Holder.lean:498` **← headline**
...
flowchart TD
  ...
  n22["★ exists_selector_indicator_sieve_uniform_holder_approximation_rate_of_cover"]
  n23["★ selector_indicator_uniform_sieve_holder_approximation_rate_of_cover"]
  n2 --> n0
  n2 --> n1
  n5 --> n3
  n5 --> n4
