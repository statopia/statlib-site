# Proof narrative — exists_reluNetworkClass_holderSmooth_unitCube_fixed_width_exact_grid_explicit_depth_and_error_budget

Root: **exists_reluNetworkClass_holderSmooth_unitCube_fixed_width_exact_grid_explicit_depth_and_error_budget** (theorem) `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:22472` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ◆ `axisAlignedBoxTentWeight` — noncomputable def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:379`  _(also used by 13: axisAlignedBoxTentWeight_partition_pointwise_approximation_error_bound, exists_reluNetworkClass_axisAlignedBoxTentWeight_approx_with_size_bound, finite_axisAligned_tent_weighted_local_reluNetworkClass_global_error_bound, …)_
    ...
    ▣ `FullyConnectedReLUNet` — structure · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:167`  _(also used by 46: reluNetworkClass_classApproximationError_le_of_pointwise_candidate, reluNetworkClass_classApproximationError_le_of_candidate_ise, reluNetworkClass_classApproximationError_le_of_exists_pointwise, …)_
    ...
    ◆ `realize` — noncomputable def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:55`  _(also used by 50: reluNetworkClass_classApproximationError_le_of_pointwise_candidate, reluNetworkClass_classApproximationError_le_of_candidate_ise, reluNetworkClass_classApproximationError_le_of_exists_pointwise, …)_
  ...
  ◆ `fullyConnectedReLUParameterCount` — def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:70`  _(also used by 51: exists_fullyConnectedReLUNet_unitInterval_square_approx, exists_fullyConnectedReLUNet_interval_square_approx, exists_fullyConnectedReLUNet_mul_approx_on_box, …)_
      ...
      ★ `finite_linear_combination_reluNetworkClass_serial_fixed_width_network_witness_bound` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:20257`
    ★ `finite_linear_combination_reluNetworkClass_serial_fixed_width_explicit_depth_bound` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:22250`
  ...
  ★ `finite_axisAligned_tent_weighted_local_reluNetworkClass_serial_fixed_width_explicit_depth_global_error_bound` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:22351`
★ `exists_reluNetworkClass_holderSmooth_unitCube_fixed_width_exact_grid_explicit_depth_and_error_budget` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:22472` **← headline**
...
flowchart TD
  ...
  n18["◆ reluApply"]
  n19["◆ hiddenState"]
  n20["★ finite_linear_combination_reluNetworkClass_serial_fixed_width_network_witness_bound"]
  n21["★ finite_linear_combination_reluNetworkClass_serial_fixed_width_explicit_depth_bound"]
  ...
  n24["★ finite_axisAligned_tent_weighted_local_reluNetworkClass_serial_fixed_width_explicit_depth_global_error_bound"]
  n25["★ exists_reluNetworkClass_holderSmooth_unitCube_fixed_width_exact_grid_explicit_depth_and_error_budget"]
  n2 --> n1
  n3 --> n0
  n3 --> n1
  n4 --> n0
