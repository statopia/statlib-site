# Proof narrative — seriesFunction_uniform_bound_of_basis_bound

Root: **seriesFunction_uniform_bound_of_basis_bound** (theorem) `Statlib/Nonparametric/Approximation/Sieve.lean:29` · topic `Nonparametric`
...
★ `seriesFunction_uniform_bound_of_basis_bound` — theorem · `Statlib/Nonparametric/Approximation/Sieve.lean:29` **← headline**
...
flowchart TD
  ...
  n2["▣ DenseLayer"]
  n3["◆ apply"]
  n4["★ seriesFunction_uniform_bound_of_basis_bound"]
  n2 --> n1
  n3 --> n2
  n3 --> n1
  n4 --> n0
