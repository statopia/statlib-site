# Proof narrative — classApproximationError_le_of_member_ise

Root: **classApproximationError_le_of_member_ise** (theorem) `Statlib/Nonparametric/Approximation/Metric.lean:49` · topic `Nonparametric`
...
★ `classApproximationError_le_of_member_ise` — theorem · `Statlib/Nonparametric/Approximation/Metric.lean:49` **← headline**
...
flowchart TD
  ...
  n3["★ classApproximationError_le_of_member_ise"]
  n2 --> n0
  n2 --> n1
  n3 --> n0
  n3 --> n1
