# Proof narrative — HasEnvelope

Root: **HasEnvelope** (def) `Statlib/Nonparametric/Vocabulary/FunctionClasses.lean:28` · topic `Nonparametric`
...
◆ `HasEnvelope` — def · `Statlib/Nonparametric/Vocabulary/FunctionClasses.lean:28` **← headline**
