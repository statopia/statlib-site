# Proof narrative — reluNetworkClass_classApproximationError_le_of_exists_pointwise

Root: **reluNetworkClass_classApproximationError_le_of_exists_pointwise** (theorem) `Statlib/Nonparametric/Approximation/NeuralNetwork.lean:72` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ◆ `parameterCount` — def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:39`  _(also used by 32: reluNetworkClass_classApproximationError_le_of_pointwise_candidate, reluNetworkClass_classApproximationError_le_of_candidate_ise, exists_fullyConnectedReLUNet_unitInterval_square_approx, …)_
  ▣ `FullyConnectedReLUNet` — structure · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:167`  _(also used by 48: reluNetworkClass_classApproximationError_le_of_pointwise_candidate, reluNetworkClass_classApproximationError_le_of_candidate_ise, exists_fullyConnectedReLUNet_unitInterval_square_approx, …)_
  ...
  ◆ `realize` — noncomputable def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:55`  _(also used by 51: reluNetworkClass_classApproximationError_le_of_pointwise_candidate, reluNetworkClass_classApproximationError_le_of_candidate_ise, unitIntervalSquareReLUHingeNet_realize, …)_
  ...
  ◆ `reluNetworkClass` — def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:219`  _(also used by 47: reluNetworkClass_classApproximationError_le_of_pointwise_candidate, reluNetworkClass_classApproximationError_le_of_candidate_ise, exists_reluNetworkClass_holderSmooth_local_approx_on_centered_box_with_symbolic_budget, …)_
...
★ `reluNetworkClass_classApproximationError_le_of_exists_pointwise` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetwork.lean:72` **← headline**
...
flowchart TD
  ...
  n13["★ reluNetworkClass_classApproximationError_le_of_exists_pointwise"]
  n1 --> n0
  n2 --> n1
  n3 --> n1
  n4 --> n1
