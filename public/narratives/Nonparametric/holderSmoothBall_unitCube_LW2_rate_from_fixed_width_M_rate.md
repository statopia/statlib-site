# Proof narrative — holderSmoothBall_unitCube_LW2_rate_from_fixed_width_M_rate

Root: **holderSmoothBall_unitCube_LW2_rate_from_fixed_width_M_rate** (theorem) `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:22519` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ★ `holderSmoothBall_unitCube_LW2_rate_from_depth_width_scale_rate` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:20158`
★ `holderSmoothBall_unitCube_LW2_rate_from_fixed_width_M_rate` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:22519` **← headline**
...
flowchart TD
  ...
  n15["★ holderSmoothBall_unitCube_LW2_rate_from_depth_width_scale_rate"]
  n16["★ holderSmoothBall_unitCube_LW2_rate_from_fixed_width_M_rate"]
  n3 --> n2
  n4 --> n1
  n4 --> n2
  n5 --> n1
