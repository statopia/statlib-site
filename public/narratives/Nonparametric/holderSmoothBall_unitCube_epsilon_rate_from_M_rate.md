# Proof narrative — holderSmoothBall_unitCube_epsilon_rate_from_M_rate

Root: **holderSmoothBall_unitCube_epsilon_rate_from_M_rate** (theorem) `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:13633` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ★ `exists_nat_scale_for_rpow_epsilon_rate` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:13520`
  ★ `fullyConnectedReLUParameterCount_fixed_width_le_linear_depth` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:13492`
★ `holderSmoothBall_unitCube_epsilon_rate_from_M_rate` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:13633` **← headline**
...
flowchart TD
  ...
  n15["★ exists_nat_scale_for_rpow_epsilon_rate"]
  n16["★ fullyConnectedReLUParameterCount_fixed_width_le_linear_depth"]
  n17["★ holderSmoothBall_unitCube_epsilon_rate_from_M_rate"]
  n3 --> n2
  n4 --> n1
  n4 --> n2
  n5 --> n1
