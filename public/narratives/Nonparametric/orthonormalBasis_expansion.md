# Proof narrative — orthonormalBasis_expansion

Root: **orthonormalBasis_expansion** (theorem) `Statlib/Nonparametric/FunctionalData/Regression.lean:428` · topic `Nonparametric`
...
★ `orthonormalBasis_expansion` — theorem · `Statlib/Nonparametric/FunctionalData/Regression.lean:428` **← headline**
