# Proof narrative — kernel_regression_centered_mse_bound_of_random_design_regularity

Root: **kernel_regression_centered_mse_bound_of_random_design_regularity** (theorem) `Statlib/Nonparametric/KernelRegression/KernelRate.lean:1316` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ◆ `KernelRegressionCenteredMSEBound` — def · `Statlib/Nonparametric/Vocabulary/KernelRegression.lean:208`  _(also used by 2: kernel_centered_mse_bound_of_uniform_design_interior_bounded, kernel_centered_error_bridge_from_centered_mse_bound)_
  ...
  ◆ `KernelRegressionRandomDesignRegularityAssumptions` — def · `Statlib/Nonparametric/Vocabulary/KernelRegression.lean:365`  _(also used by 2: kernel_regression_design_l2_energy_of_random_design_regularity, kernel_regression_risk_integrability_of_random_design_regularity)_
★ `kernel_regression_centered_mse_bound_of_random_design_regularity` — theorem · `Statlib/Nonparametric/KernelRegression/KernelRate.lean:1316` **← headline**
...
flowchart TD
  ...
  n9["★ kernel_regression_centered_mse_bound_of_random_design_regularity"]
  n2 --> n1
  n3 --> n0
  n3 --> n2
  n4 --> n0
