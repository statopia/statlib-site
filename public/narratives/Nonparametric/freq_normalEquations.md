# Proof narrative — freq_normalEquations

Root: **freq_normalEquations** (theorem) `Statlib/Nonparametric/FunctionalData/Regression.lean:19` · topic `Nonparametric`
...
★ `freq_normalEquations` — theorem · `Statlib/Nonparametric/FunctionalData/Regression.lean:19` **← headline**
