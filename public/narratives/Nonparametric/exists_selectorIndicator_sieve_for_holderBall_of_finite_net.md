# Proof narrative — exists_selectorIndicator_sieve_for_holderBall_of_finite_net

Root: **exists_selectorIndicator_sieve_for_holderBall_of_finite_net** (theorem) `Statlib/Nonparametric/Approximation/Holder.lean:352` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ◆ `holderBall` — def · `Statlib/Nonparametric/Vocabulary/FunctionClasses.lean:56`  _(also used by 7: holderBall_classApproximationError_self_le_zero, exists_selectorIndicatorSieve_for_holderBall_of_finite_measurable_cover, exists_selectorIndicatorSieve_for_holderBall_rate_of_cover, …)_
  ...
  ◆ `sieveApproximationError` — noncomputable def · `Statlib/Nonparametric/Vocabulary/Sieve.lean:42`  _(also used by 20: sieveApproximationError_le_of_holder_selector_net, exists_selectorIndicatorSieve_for_holderBall_of_finite_measurable_cover, exists_selectorIndicatorSieve_for_holderBall_rate_of_cover, …)_
  ◆ `selectorIndicatorSieve` — def · `Statlib/Nonparametric/Approximation/Sieve.lean:401`  _(also used by 10: holder_selectorIndicator_series_integratedSquaredError_bound, finiteLinearSpan_classApproximationError_le_of_holder_selector_net, sieveApproximationError_le_of_holder_selector_net, …)_
  ...
  ★ `exists_selectorIndicatorSieve_for_holderBall_of_finite_net` — theorem · `Statlib/Nonparametric/Approximation/Holder.lean:299`  _(also used by 2: exists_selectorIndicatorSieve_for_holderBall_of_finite_measurable_cover, exists_selectorIndicatorSieve_for_holderBall_rate_of_cover)_
★ `exists_selectorIndicator_sieve_for_holderBall_of_finite_net` — theorem · `Statlib/Nonparametric/Approximation/Holder.lean:352` **← headline**
...
flowchart TD
  ...
  n22["★ exists_selectorIndicator_sieve_for_holderBall_of_finite_net"]
  n2 --> n0
  n2 --> n1
  n5 --> n3
  n5 --> n4
