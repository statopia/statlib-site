# Proof narrative — series_function_lipschitz_of_basis_lipschitz

Root: **series_function_lipschitz_of_basis_lipschitz** (theorem) `Statlib/Nonparametric/Approximation/Sieve.lean:106` · topic `Nonparametric`
...
★ `series_function_lipschitz_of_basis_lipschitz` — theorem · `Statlib/Nonparametric/Approximation/Sieve.lean:106` **← headline**
...
flowchart TD
  ...
  n2["▣ DenseLayer"]
  n3["◆ apply"]
  n4["★ series_function_lipschitz_of_basis_lipschitz"]
  n2 --> n1
  n3 --> n2
  n3 --> n1
  n4 --> n0
