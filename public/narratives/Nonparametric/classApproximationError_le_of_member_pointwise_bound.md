# Proof narrative — classApproximationError_le_of_member_pointwise_bound

Root: **classApproximationError_le_of_member_pointwise_bound** (theorem) `Statlib/Nonparametric/Approximation/Metric.lean:60` · topic `Nonparametric`
...
★ `classApproximationError_le_of_member_pointwise_bound` — theorem · `Statlib/Nonparametric/Approximation/Metric.lean:60` **← headline**
...
flowchart TD
  ...
  n3["★ classApproximationError_le_of_member_pointwise_bound"]
  n2 --> n0
  n2 --> n1
  n3 --> n0
  n3 --> n1
