# Proof narrative — exists_reluNetworkClass_holderSmooth_local_approx_on_centered_box_with_symbolic_budget

Root: **exists_reluNetworkClass_holderSmooth_local_approx_on_centered_box_with_symbolic_budget** (theorem) `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:6250` · topic `Nonparametric`
...
Reading order (foundations first, headline last):
  ...
  ◆ `holderSmoothBall` — def · `Statlib/Nonparametric/Vocabulary/FunctionClasses.lean:86`  _(also used by 74: exists_fullyConnectedReLUNet_holderSmooth_local_approx_on_centered_box_with_size_bound, exists_fullyConnectedReLUNet_holderSmooth_local_approx_on_centered_box, exists_fullyConnectedReLUNet_holderSmooth_local_approx_on_centered_box_with_depth_bound, …)_
    ◆ `centeredMonomialApproxError` — noncomputable def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:79`  _(also used by 10: exists_reluNetworkClass_holderSmooth_local_approx_on_centered_box_with_coefficient_budget, finite_holderSmooth_local_table_reluNetworkClass_active_cell_error_bound, exists_reluNetworkClass_holderSmooth_axisAligned_tent_partition_approximation_on_domain_bound, …)_
...
flowchart TD
  ...
  n11["◆ finiteCenteredMonomialPolynomialApproxError"]
  n12["◆ bias"]
  n13["▣ DenseLayer"]
  n14["◆ parameterCount"]
  ...
  n18["◆ apply"]
  n19["◆ realize"]
  n20["◆ reluNetworkClass"]
  n21["◆ finiteLinearCombination"]
  ...
  n42["★ exists_reluNetworkClass_holderSmooth_local_approx_on_centered_box_with_symbolic_budget"]
  n2 --> n1
  n4 --> n3
  n4 --> n0
  n4 --> n2
