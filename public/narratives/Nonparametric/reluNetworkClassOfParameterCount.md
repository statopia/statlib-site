# Proof narrative — reluNetworkClassOfParameterCount

Root: **reluNetworkClassOfParameterCount** (def) `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:230` · topic `Nonparametric`
...
◆ `reluNetworkClassOfParameterCount` — def · `Statlib/Nonparametric/Vocabulary/NeuralNetwork.lean:230` **← headline**
...
flowchart TD
  ...
  n7["◆ apply"]
  n8["◆ realize"]
  n9["◆ reluNetworkClassOfParameterCount"]
  n1 --> n0
  n2 --> n1
  n4 --> n1
  n5 --> n1
