# Proof narrative — exists_selectorIndicatorSieve_for_holderBall_rate_of_finite_measurable_cover

Root: **exists_selectorIndicatorSieve_for_holderBall_rate_of_finite_measurable_cover** (theorem) `Statlib/Nonparametric/Approximation/Holder.lean:463` · topic `Nonparametric`
Closure: 25 declarations across 8 files. Generated from `proof_graph.json` — no files were moved.
...
Reading order (foundations first, headline last):
  ...
  ★ `finiteMeasurableCover_exists_measurable_selector` — theorem · `Statlib/Nonparametric/Approximation/Sieve.lean:321`  _(also used by 1: exists_selectorIndicatorSieve_for_holderBall_of_finite_measurable_cover)_
  ...
  ★ `exists_selectorIndicatorSieve_for_holderBall_rate_of_cover` — theorem · `Statlib/Nonparametric/Approximation/Holder.lean:372`  _(also used by 1: holderBall_selectorIndicator_sieveApproximationError_rate_of_cover)_
★ `exists_selectorIndicatorSieve_for_holderBall_rate_of_finite_measurable_cover` — theorem · `Statlib/Nonparametric/Approximation/Holder.lean:463` **← headline**
...
flowchart TD
  ...
  n7["★ finiteMeasurableCover_exists_measurable_selector"]
  n8["★ integratedSquaredError_le_of_pointwise_bound"]
  n9["★ sieveApproximationError_le_of_coefficients"]
  n10["★ sieveApproximationError_le_of_pointwise_series_bound"]
  n11["◆ bias"]
  n12["▣ DenseLayer"]
  n13["◆ apply"]
  n14["★ sieveApproximationError_range_bddBelow"]
  n15["★ sieveApproximationError_le_of_exists_pointwise_series"]
  n16["★ sieveApproximationError_uniform_bound_of_exists_pointwise_series"]
  n17["★ selectorIndicator_seriesFunction_measurable"]
  n18["★ selectorIndicatorSieve_seriesFunction_measurable"]
  n19["★ selectorIndicatorSieve_seriesFunction_eq"]
  n20["★ holder_selectorIndicator_series_pointwise_bound"]
  n21["★ holderBall_selectorIndicator_sieveApproximationError_uniform_bound"]
  n22["★ exists_selectorIndicatorSieve_for_holderBall_of_finite_net"]
  n23["★ exists_selectorIndicatorSieve_for_holderBall_rate_of_cover"]
  n24["★ exists_selectorIndicatorSieve_for_holderBall_rate_of_finite_measurable_cover"]
  n2 --> n0
  n2 --> n1
  n5 --> n3
  n5 --> n4
