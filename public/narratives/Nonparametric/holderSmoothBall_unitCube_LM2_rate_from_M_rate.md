# Proof narrative — holderSmoothBall_unitCube_LM2_rate_from_M_rate

Root: **holderSmoothBall_unitCube_LM2_rate_from_M_rate** (theorem) `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:19952` · topic `Nonparametric`
...
★ `holderSmoothBall_unitCube_LM2_rate_from_M_rate` — theorem · `Statlib/Nonparametric/Approximation/NeuralNetworkAlgebra.lean:19952` **← headline**
...
flowchart TD
  ...
  n15["★ holderSmoothBall_unitCube_LM2_rate_from_M_rate"]
  n3 --> n2
  n4 --> n1
  n4 --> n2
  n5 --> n1
