# Proof narrative — localGaussianComplexity_le_of_satisfiesCriticalInequality

Root: **localGaussianComplexity_le_of_satisfiesCriticalInequality** (lemma) `Statlib/Regression/localGaussianComplexity_le_of_satisfiesCriticalInequality.lean:12` · topic `Regression`
...
· `localGaussianComplexity_le_of_satisfiesCriticalInequality` — lemma · `Statlib/Regression/localGaussianComplexity_le_of_satisfiesCriticalInequality.lean:12` **← headline**
...
flowchart TD
  ...
  n7["· localGaussianComplexity_le_of_satisfiesCriticalInequality"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n4 --> n3
