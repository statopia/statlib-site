# Proof narrative — regression_full_interface_of_process_and_entropy_structured_master_bound

Root: **regression_full_interface_of_process_and_entropy_structured_master_bound** (theorem) `Statlib/Regression/regression_full_interface_of_process_and_entropy_structured_master_bound.lean:11` · topic `Regression`
...
Reading order (foundations first, headline last):
  ...
  ◆ `empiricalNorm` — def · `Statlib/Regression/empiricalNorm.lean:10`  _(also used by 20: LocalizedProbabilityAssumptions.ofProcessAndComplexity, LocalizedProbabilityAssumptions.ofProxy, empiricalSphere, …)_
  ...
  ▣ `LocalizedProbabilityAssumptions` — structure · `Statlib/Regression/LocalizedProbabilityAssumptions.lean:12`  _(also used by 15: LocalizedProbabilityAssumptions.ofProcessAndComplexity, LocalizedProbabilityAssumptions.ofProxy, l1_regression_full_interface_of_probability_structured_master_bound, …)_
...
★ `regression_full_interface_of_process_and_entropy_structured_master_bound` — theorem · `Statlib/Regression/regression_full_interface_of_process_and_entropy_structured_master_bound.lean:11` **← headline**
...
flowchart TD
  ...
  n16["★ regression_full_interface_of_process_and_entropy_structured_master_bound"]
  n1 --> n0
  n2 --> n0
  n3 --> n0
  n4 --> n0
