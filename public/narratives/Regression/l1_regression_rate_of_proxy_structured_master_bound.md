# Proof narrative — l1_regression_rate_of_proxy_structured_master_bound

Root: **l1_regression_rate_of_proxy_structured_master_bound** (theorem) `Statlib/Regression/l1_regression_rate_of_proxy_structured_master_bound.lean:10` · topic `Regression`
...
Reading order (foundations first, headline last):
  ...
  ★ `l1_regression_rate_of_deterministic_structured_master_bound` — theorem · `Statlib/Regression/l1_regression_rate_of_deterministic_structured_master_bound.lean:11`  _(also used by 2: l1_regression_rate_of_process_and_complexity_structured_master_bound, l1_regression_rate_of_process_and_entropy_structured_master_bound)_
★ `l1_regression_rate_of_proxy_structured_master_bound` — theorem · `Statlib/Regression/l1_regression_rate_of_proxy_structured_master_bound.lean:10` **← headline**
...
flowchart TD
  ...
  n10["★ l1_regression_rate_of_proxy_structured_master_bound"]
  n1 --> n0
  n2 --> n0
  n3 --> n0
  n3 --> n2
