# Proof narrative — linear_regression_rate_of_master_bound

Root: **linear_regression_rate_of_master_bound** (theorem) `Statlib/Regression/linear_regression_rate_of_master_bound.lean:12` · topic `Regression`
...
Reading order (foundations first, headline last):
  ...
  ★ `regression_rate_of_master_bound` — theorem · `Statlib/Regression/regression_rate_of_master_bound.lean:11`  _(also used by 3: l1_regression_rate_of_master_bound, regression_full_interface_of_probability_structured_master_bound, regression_rate_of_deterministic_structured_master_bound)_
★ `linear_regression_rate_of_master_bound` — theorem · `Statlib/Regression/linear_regression_rate_of_master_bound.lean:12` **← headline**
...
flowchart TD
  ...
  n5["★ linear_regression_rate_of_master_bound"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n3 --> n0
