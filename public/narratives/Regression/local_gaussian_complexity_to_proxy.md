# Proof narrative — local_gaussian_complexity_to_proxy

Root: **local_gaussian_complexity_to_proxy** (theorem) `Statlib/Regression/local_gaussian_complexity_to_proxy.lean:13` · topic `Regression`
Closure: 10 declarations across 9 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

  ▣ `RegressionModel` — structure · `Statlib/Regression/Basic.lean:29`  _(also used by 76: excessRisk, IsStarShapedClass, LocalGaussianComplexityEntropyAssumptions, …)_
...
★ `local_gaussian_complexity_to_proxy` — theorem · `Statlib/Regression/local_gaussian_complexity_to_proxy.lean:13` **← headline**
...
flowchart TD
  ...
  n8["◆ estimationErrorUpper"]
  n9["★ local_gaussian_complexity_to_proxy"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n4 --> n3
