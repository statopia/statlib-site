# Proof narrative — lasso_prediction_error

Root: **lasso_prediction_error** (theorem) `Statlib/Regression/lasso_prediction_error.lean:16` · topic `Regression`
...
Reading order (foundations first, headline last):
  ...
  ◆ `IsLassoEstimator` — def · `Statlib/Regression/IsLassoEstimator.lean:15`  _(also used by 3: IsAdaptiveLassoEstimator.isLassoEstimator_of_w_one, lasso_l1_error, lasso_l2_error_on_support)_
  ...
  ◆ `RestrictedEigenvalue` — def · `Statlib/Regression/RestrictedEigenvalue.lean:18`  _(also used by 3: lasso_l1_error, lasso_l2_error_on_support, sqrt_lasso_oracle_bound)_
  ...
  · `l1Norm_nonneg` — lemma · `Statlib/Regression/l1Norm_nonneg.lean:13`  _(also used by 5: elasticNetLoss_nonneg, fusedLassoLoss_nonneg, lasso_l2_error_on_support, …)_
  ★ `lasso_slow_rate` — theorem · `Statlib/Regression/lasso_slow_rate.lean:23`  _(also used by 2: lasso_l1_error, lasso_l2_error_on_support)_
★ `lasso_prediction_error` — theorem · `Statlib/Regression/lasso_prediction_error.lean:16` **← headline**
