# Proof narrative — linear_regression_rate

Root: **linear_regression_rate** (theorem) `Statlib/Regression/linear_regression_rate.lean:9` · topic `Regression`
...
★ `linear_regression_rate` — theorem · `Statlib/Regression/linear_regression_rate.lean:9` **← headline**
