# Proof narrative — master_error_bound_localized_of_process_and_entropy_structured

Root: **master_error_bound_localized_of_process_and_entropy_structured** (theorem) `Statlib/Regression/master_error_bound_localized_of_process_and_entropy_structured.lean:13` · topic `Regression`
...
Reading order (foundations first, headline last):
  ...
  ★ `master_error_bound_localized_structured` — theorem · `Statlib/Regression/master_error_bound_localized_structured.lean:14`  _(also used by 3: master_error_bound_localized_of_process_and_complexity_structured, master_error_bound_localized_of_proxy_structured, regression_rate_of_deterministic_structured_master_bound)_
★ `master_error_bound_localized_of_process_and_entropy_structured` — theorem · `Statlib/Regression/master_error_bound_localized_of_process_and_entropy_structured.lean:13` **← headline**
...
flowchart TD
  ...
  n7["★ master_error_bound_localized_of_process_and_entropy_structured"]
  n1 --> n0
  n2 --> n0
  n2 --> n1
  n3 --> n0
