# Proof narrative — gaussian_lipschitz_concentration_of_universal_herbst
...
Closure: 183 declarations across 39 files. Generated from `proof_graph.json` — no files were moved.

Reading order (foundations first, headline last):

    ◆ `stdGaussian` — abbrev · `Statlib/Gaussian/Basic.lean:29`  _(also used by 55: memLp_polynomial_gaussianReal, integrable_polynomial_mul_gaussianPDFReal, memLp_aeval_intPolynomial_gaussianReal, …)_
  ◆ `stdGaussianPi` — def · `Statlib/Gaussian/Basic.lean:32`  _(also used by 36: GaussianSobolevRegularity, isProbabilityMeasure_stdGaussianPi, sigmaFinite_stdGaussianPi, …)_
      ◆ `HerbstBound` — def · `Statlib/SubGaussian/HerbstBound.lean:13`  _(also used by 3: UniversalHerbstBound, herbst_argument_of_bound, universalHerbst_of_lipschitz)_
      ★ `gaussian_lipschitz_upper_tail_of_expIntegrable` — theorem · `Statlib/SubGaussian/gaussian_lipschitz_upper_tail_of_expIntegrable.lean:13`  _(also used by 1: gaussian_lipschitz_upper_tail)_
      · `herbstBound_neg` — lemma · `Statlib/SubGaussian/herbstBound_neg.lean:13`
    ★ `gaussian_lipschitz_concentration_of_expIntegrable` — theorem · `Statlib/SubGaussian/gaussian_lipschitz_concentration_of_expIntegrable.lean:13`
    ...
    · `integrable_exp_centered_of_lipschitz_stdGaussianPi` — lemma · `Statlib/Gaussian/Basic.lean:310`  _(also used by 1: gaussian_lipschitz_upper_tail)_
    ...
    ★ `herbst_argument_core` — theorem · `Statlib/SubGaussian/herbst_argument_core.lean:14`  _(also used by 2: gaussian_lipschitz_upper_tail, herbst_argument)_
  ★ `gaussian_lipschitz_concentration` — theorem · `Statlib/SubGaussian/gaussian_lipschitz_concentration.lean:15`
★ `gaussian_lipschitz_concentration_of_universal_herbst` — theorem · `Statlib/SubGaussian/gaussian_lipschitz_concentration_of_universal_herbst.lean:11` **← headline**

> Closure has 183 declarations — diagram omitted (cap 60).
